...
#define QSH_AUDIO_OSA_THREAD_NAME_MAX_LEN   15  /**< excluding terminating NULL */

/*=============================================================================
  Type Definitions
  ===========================================================================*/

typedef uint32_t                qsh_audio_osa_thread_sigs;  /**< 32-bit signal */
typedef struct qsh_audio_osa_thread   qsh_audio_osa_thread;     /**< OS dependent thread */
typedef union
{
  char                      __size[__SIZEOF_ATTR_THREAD]; /**< OS dependent */
  long int                  __alignment;
} qsh_audio_osa_thread_attr;

typedef void  *qsh_audio_osa_thread_func_arg;
typedef void (*qsh_audio_osa_thread_func)(qsh_audio_osa_thread_func_arg);
...
/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_init
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_init(
  qsh_audio_osa_thread_attr*      attrib);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_set_stack
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_set_stack(
  qsh_audio_osa_thread_attr      *attrib,
...
/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_set_kernel_stack_size
  -----------------------------------------------------------------------------

  @brief Sets the kernel stack size for island threads. No effect on big-image
    threads.
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_set_kernel_stack_size(
  qsh_audio_osa_thread_attr      *attrib,
  size_t                    kernel_stack_size);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_set_priority
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_set_priority(
  qsh_audio_osa_thread_attr      *attrib,
  uint8_t                   priority);
...
/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_set_name
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_set_name(
  qsh_audio_osa_thread_attr      *attrib,
  const char               *name);
...
/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_set_memory_partition
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_set_memory_partition(
  qsh_audio_osa_thread_attr      *attrib,
...
/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_attr_set_user_info
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_attr_set_user_info(
  qsh_audio_osa_thread_attr    *attrib,
  void                   *info);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_create
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_create(
  qsh_audio_osa_thread_func         thread_func,
  qsh_audio_osa_thread_func_arg     thread_func_arg,
  const qsh_audio_osa_thread_attr  *attrib,
  qsh_audio_osa_thread            **thread);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_delete
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_delete(
  qsh_audio_osa_thread             *thread);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_sigs_wait
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_sigs_wait(
  qsh_audio_osa_thread_sigs         sigs_mask,
  qsh_audio_osa_thread_sigs        *sigs_rcvd);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_sigs_set
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_sigs_set(
  qsh_audio_osa_thread             *thread,
  qsh_audio_osa_thread_sigs         sigs);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_sigs_check
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_thread_sigs_check(
  qsh_audio_osa_thread_sigs         sigs_mask,
  bool                        consume,
  qsh_audio_osa_thread_sigs        *sigs_rcvd);
...
/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_get_priority
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
uint8_t qsh_audio_osa_thread_get_priority(void);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_set_priority
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
uint8_t qsh_audio_osa_thread_set_priority(
  uint8_t                   priority);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_get_user_info
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
void *qsh_audio_osa_thread_get_user_info(void);
...
/*!
  ...
  -----------------------------------------------------------------------------
*/
void qsh_audio_osa_init(void);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_active
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
  */
void qsh_audio_osa_thread_active(void);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_thread_idle
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
  */
void qsh_audio_osa_thread_idle(void);
