...
/*=============================================================================
  ...
  $Id: //components/rel/qsh.drivers/1.0.2/qsh_audio/utils/osa/inc/qsh_audio_osa_lock.h#1 $
  $DateTime: 2025/08/18 04:02:39 $
  $Change: 65977835 $
  ===========================================================================*/
...
} qsh_audio_osa_lock  __attribute__((aligned(8))); /**< OS dependent locking mechanism */

typedef union
{
  char                      __size[__SIZEOF_ATTR_LOCK]; /**< OS dependent */
  long int                  __alignment;
} qsh_audio_osa_lock_attr;
...
/*!
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_attr_init(
  qsh_audio_osa_lock_attr             *attrib);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_lock_attr_set_memory_partition
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_attr_set_memory_partition(
  qsh_audio_osa_lock_attr      *attrib,
...
/*!
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_create(
  const qsh_audio_osa_lock_attr  *attrib,
  qsh_audio_osa_lock             **lock);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_lock_init
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_init(
  const qsh_audio_osa_lock_attr  *attrib,
  qsh_audio_osa_lock             *lock);
...
/*!
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_delete(
  qsh_audio_osa_lock             *lock);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_lock_deinit
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_deinit(
  qsh_audio_osa_lock             *lock);

/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_lock_acquire
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_acquire(
  qsh_audio_osa_lock             *lock);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_lock_try_acquire
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_try_acquire(
  qsh_audio_osa_lock             *lock);


/*!
  -----------------------------------------------------------------------------
  qsh_audio_osa_lock_release
  -----------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------
*/
sns_rc qsh_audio_osa_lock_release(
  qsh_audio_osa_lock             *lock);
