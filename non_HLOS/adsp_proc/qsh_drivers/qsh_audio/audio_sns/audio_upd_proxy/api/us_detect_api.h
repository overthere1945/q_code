...
$Header: //components/dev/qsh.drivers/1.0/dekantha.qsh.drivers.1.0.sensorbuild_3_18/qsh_audio/audio_api/us_detect_api.h#1 $

when       who     what, where, why
--------   ---     -------------------------------------------------------------
 02/13/21   ggilalka   Created file.
 ...
 */
#define MODULE_ID_EXAMPLE_US_DETECT  0x070010D7
