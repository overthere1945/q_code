...
static sns_rc notify_event(sns_sensor_instance *const this)
{
  UNUSED_VAR(this);
...
static sns_rc init(sns_sensor_instance *const this,
...
static sns_rc set_client_config(sns_sensor_instance *const this,
...
static sns_rc deinit(sns_sensor_instance *const this)
{
  sns_suid_sensor_instance_config *state =
      (sns_suid_sensor_instance_config *)this->state->state;
...
const sns_sensor_instance_api suid_sensor_instance_api = {
