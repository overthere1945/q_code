...
{
  /* This flag is set when online/ offline playback feature is enabled */
  bool timer_disable;
  /* Indicates whether the timer is currently armed */
  bool timer_active;
  /* Timer used to remove unsupported pending suid requests */
  struct sns_timer *timer;
  /* Timer signal handle */
  sns_signal_handle *timer_sig_handle;
