 ...
 * @file
 *
 * @brief Absolute motion detector header file.
 *
...
/**
 * @brief QMD motion detected state
 *
 */
typedef enum
{
...
/**
 * @brief amd_persist
 * AMD algorithm information to be stored in persistent memory.
...
typedef struct
{
  ...
  bool accelAvailable;      /*!< Accel availability */
