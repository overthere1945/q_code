...
/* This option is only valid if the QSO_IPCR_SET_CONTROL_PORT
 * option is set on the socket. This will filter the client removal events
 * sent to the control port based on the port and msg type passed */
#define QSO_IPCR_SET_CLIENT_PREF       3
