...
/*===========================================================================
  FUNCTION  qsocket_get_pd
===========================================================================*/
/*!
@brief

  Gets the pd num corresponding to ipcr address

@param[in]   fd        Socket descriptor of a socket in root pd
@param[in]   addr      Pointer to socket address whose creation pd needs to be found 

@return
  int  pd number of qsocket address if the qsocket is found
       -1 if the address is not found
       other negative numbers will indicate ipcr related errors
...
@note
  ...
  - Side Effects
    - First parameter fd should be the file descriptor of the socket created
      in the root pd
*/
/*=========================================================================*/
int qsocket_get_pd(int fd, struct qsockaddr * addr);
