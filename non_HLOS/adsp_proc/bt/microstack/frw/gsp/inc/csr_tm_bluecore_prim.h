...
#define CSR_TM_BLUECORE_REGISTER_HCI_EVENT_HANDLER_REQ ((CsrTmBlueCorePrim) (0x000C + CSR_TM_PRIM_DOWNSTREAM_LOWEST))

#define CSR_TM_PRIM_DOWNSTREAM_HIGHEST                                      (0x000C + CSR_TM_PRIM_DOWNSTREAM_LOWEST)
/*******************************************************************************/
...
#define CSR_TM_BLUECORE_REGISTER_HCI_EVENT_HANDLER_CFM ((CsrTmBlueCorePrim) (0x0010 + CSR_TM_PRIM_UPSTREAM_LOWEST))

#define CSR_TM_PRIM_UPSTREAM_HIGHEST                                        (0x0010 + CSR_TM_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    CsrTmBlueCorePrim type;
    CsrSchedQid       phandle;
    CsrSchedQid       hciEvtHandler;
} CsrTmBluecoreRegisterHciEventHandlerReq;

typedef struct
{
    CsrTmBlueCorePrim type;
} CsrTmBluecoreRegisterHciEventHandlerCfm;
