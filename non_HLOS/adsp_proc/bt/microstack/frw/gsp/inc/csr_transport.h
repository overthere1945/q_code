...
#define TRANSPORT_CHANNEL_ISO                (26)
#define TRANSPORT_CHANNEL_IPC_CUSTOM         (27)
#define TRANSPORT_CHANNEL_ACL_PRIMARY_STACK  (28)
#define TRANSPORT_CHANNEL_PERI               (29)
...
#define TRANSPORT_TYPE_H4IBS                 (0xE) /* QCA H4 + In-Band-Sleep */
#define TRANSPORT_TYPE_IPC                   (0xF)
