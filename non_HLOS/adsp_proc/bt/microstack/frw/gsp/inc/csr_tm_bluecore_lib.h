...
/*----------------------------------------------------------------------------*
 *  NAME
 *      CsrTmBluecoreRegisterHciEventHandlerReqSend
 *
 *  DESCRIPTION
 *      Register the hci event handler with tm.
 *
 *  PARAMETERS
 *      phandle : The identity of the hci event handler.
 *----------------------------------------------------------------------------*/
...
#define CsrTmBluecoreRegisterHciEventHandlerReqSend(_ph, _hciEvtHandler){ \
        CsrTmBluecoreRegisterHciEventHandlerReq *msg__; \
        msg__ = CsrTmBluecoreRegisterHciEventHandlerReq_struct(_ph, _hciEvtHandler); \
        CsrMsgTransport(CSR_TM_BLUECORE_IFACEQUEUE, CSR_TM_BLUECORE_PRIM, msg__);}
