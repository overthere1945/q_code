 ...
 *
 *    FUNCTION:
 *        Put the received structure onto the queue. It can add another queue (m)
 *        to the main queue (q).
 *
 *    RETURN.
 *        NON
 ...
 *
 *    FUNCTION:
 *        Put the received structure onto the ABCSP queue. Unlike CsrQueueMsgAdd
 *        it adds only one message (m) to the main queue (theQueue).
 *
 *    RETURN.
 *        NON
 *****************************************************************************/
