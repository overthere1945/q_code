...
#define CSR_BCCMD_GET_CHIP_VER_REQ    ((CsrBccmdPrim) 0x0005 + CSR_BCCMD_PRIM_DOWNSTREAM_COUNT)
#define NUM_OF_CSR_BCCMD_PRIVATE_DOWNSTREAM_PRIMS (0x06)
...
#define CSR_BCCMD_GET_CHIP_VER_CFM   ((CsrBccmdPrim) ((0x0005 + CSR_BCCMD_PRIM_UPSTREAM_COUNT) | CSR_PRIM_UPSTREAM))
#define NUM_OF_CSR_BCCMD_PRIVATE_UPSTREAM_PRIMS (0x06)
...
typedef struct
{
    CsrBccmdPrim type;                      /* Event identifier                                 */
    CsrSchedQid  phandle;                     /* Handle to application                            */
} CsrBccmdGetChipVerReq;

typedef struct
{
    CsrBccmdPrim type;                      /* Event identifier                                 */
    CsrResult    status;                    /* Status information about the BCCMD transaction   */
    CsrUint16    chipver;                    /* Identifies the BlueCore chip's major version number */
} CsrBccmdGetChipVerCfm;
