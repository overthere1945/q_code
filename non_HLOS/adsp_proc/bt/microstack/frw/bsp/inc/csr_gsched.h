#ifndef CSR_GSCHED_H__
#define CSR_GSCHED_H__
/*****************************************************************************
 Copyright (c) 2008-2024, The Linux Foundation.
 All rights reserved.
*****************************************************************************/
...
#define CSR_LOG_SCHED_ENABLE
#endif

#ifdef CSR_TARGET_PRODUCT_WEARABLE_PLATFORM
#ifdef CSR_LOG_SCHED_ENABLE
#undef CSR_LOG_SCHED_ENABLE
#define CSR_LOG_SCHED_ENABLE_FOR_WEAR
#endif
#endif
 ...
 *
 *----------------------------------------------------------------------------*/
#if defined(CSR_LOG_SCHED_ENABLE)
...
#elif defined(CSR_LOG_SCHED_ENABLE_FOR_WEAR)
CsrSchedBgint CsrSchedBgintRegister(CsrSchedBgintHandler cb,
    void *context,
    const CsrCharString *id);

#define CsrSchedBgintReg(x,y,z) CsrSchedBgintRegister(x,y,z);CSR_LOG_BGINT_NAME(z);
#else
