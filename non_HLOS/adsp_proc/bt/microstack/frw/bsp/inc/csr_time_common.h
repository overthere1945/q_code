#ifndef CSR_TIME_COMMON_H__
#define CSR_TIME_COMMON_H__
/*****************************************************************************
 Copyright (c) 2009-2023, The Linux Foundation.
 All rights reserved.
*****************************************************************************/
...
/*******************************************************************************
    ...
    DESCRIPTION
        ...
        This function to be used specifically logging mechanism i.e by pcap, snoop
        and text logs so that they can get real time not the monotonic time.
...
*******************************************************************************/
CsrTime CsrTimeGetReal(CsrTime *high);

typedef CsrBool (*CsrTimeCallbackFunctionPointer)(CsrUint64 *time);

void CsrTimeRegisterCallback(CsrTimeCallbackFunctionPointer cb);

#ifdef __cplusplus
}
#endif

#endif /* CSR_TIME_COMMON_H__ */
