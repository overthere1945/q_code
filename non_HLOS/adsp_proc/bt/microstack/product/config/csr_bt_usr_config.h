...
#endif
#ifndef CSR_BT_BLUETOOTH_VERSION_5P1
#define CSR_BT_BLUETOOTH_VERSION_5P1                       (0x0A)
#endif
#ifndef CSR_BT_BLUETOOTH_VERSION_5P2
#define CSR_BT_BLUETOOTH_VERSION_5P2                       (0x0B)
#endif
#ifndef CSR_BT_BLUETOOTH_VERSION_5P3
#define CSR_BT_BLUETOOTH_VERSION_5P3                       (0x0C)
#endif
...
/* Max attribute length for the Long Read support.
 * Configure its value based on product's requirement and platform's memory availability */
#define CSR_BT_GATT_LONG_READ_ATTR_MAX_VALUE                CSR_BT_GATT_READ_ATTR_MAX_VALUE

/*---------------------------------------------------------------------------
 * Defines for EATT.
 *----------------------------------------------------------------------------*/

/* Preferred MTU size for EATT. Allowed range defined by spec : 64 - 512 octets.
 * Configure its value based on product's requirement and platform's memory availability */
#define EATT_PREFERRED_MTU                                 (0x7C)

#ifdef GATT_CACHING_CLIENT_ROLE
/* When GATT_CACHING_CLIENT_ROLE is enabled, by default GATT will enable the
 * service changed indication on the remote device.
 * Apps can disable the service changed indication by modifying GATT_SERVICE_CHANGED_CCCD
 * to GATT_CCCD_NTF_IND_DISABLE, refer csr_bt_gatt_prim.h for values */
#define GATT_SERVICE_CHANGED_CCCD                   GATT_CCCD_IND_ENABLE
 ...
 *--------------------------------------------------------------------------*/
#ifndef CSR_BT_AV_PROFILE_LARGE_MTU_SIZE
#define CSR_BT_AV_PROFILE_LARGE_MTU_SIZE                        (1015)
#endif /* CSR_BT_AV_PROFILE_LARGE_MTU_SIZE */

#ifndef CSR_BT_AV_PROFILE_DEFAULT_MTU_SIZE
#define CSR_BT_AV_PROFILE_DEFAULT_MTU_SIZE                      CSR_BT_HCI_BUILD_L2CAP_NON_EDR_MAX_FRAME_SIZE
...
#define CSR_BT_MAJOR_MINOR_DEVICE_CLASS               0x000408 /* (CSR_BT_AV_MAJOR_DEVICE_MASK + CSR_BT_HANDSFREE_AV_MINOR_DEVICE_CLASS) */
...
#define CSR_BT_CM_DEFAULT_STARTUP_CONNECTABLE_MODE                     (HCI_SCAN_ENABLE_OFF)
...
/* Default TX power level to use during inquiry */
#ifndef CSR_BT_CM_INQUIRY_TX_POWER_LEVEL_DEFAULT
#define CSR_BT_CM_INQUIRY_TX_POWER_LEVEL_DEFAULT                        4
#endif

/*--------------------------------------------------------------------------
  Defines for Synergy BT SDP connection
  ----------------------------------------------------------------------------*/
#define CSR_BT_SDP_MTU                                                  L2CA_MTU_DEFAULT

/*--------------------------------------------------------------------------
  Defines for Synergy BT RFCOMM connection
  ----------------------------------------------------------------------------*/
/* This is the number of server channels that currently can be assigned by RFCOMM */
#ifndef CSR_BT_CM_LOCAL_SERVER_CHANNELS_POOL_SIZE
#define CSR_BT_CM_LOCAL_SERVER_CHANNELS_POOL_SIZE                      30
#endif
...
#define CSR_BT_CM_INIT_CREDIT                                          (7)
...
#define CSR_BT_SCO_DEFAULT_ACCEPT_TX_BANDWIDTH                         (8000)
#endif /* CSR_BT_SCO_DEFAULT_ACCEPT_TX_BANDWIDTH */

#ifndef CSR_BT_SCO_DEFAULT_ACCEPT_RX_BANDWIDTH
#define CSR_BT_SCO_DEFAULT_ACCEPT_RX_BANDWIDTH                         (8000)
...
/* Default packet type for accept of incoming SCO and eSCO (S1, S2, S3 and S4) */
...
/* Default audio accept parameters when wide band speech is selected,
 * includes T1 and T2 settings..................................... */

/* Default MSBC : T2(2-EV3) and T1(EV3) settings to be used : 0x0388 */
#ifndef CSR_BT_HF_MSBC_DEFAULT_AUDIO_QUALITY               /* EV3 + not 3-EV3 + not 2-EV5 + not 3-EV5 */
#define CSR_BT_HF_MSBC_DEFAULT_AUDIO_QUALITY               ((hci_pkt_type_t)HCI_ESCO_PKT_EV3 | HCI_NOT_ESCO_PKT_3EV3 | HCI_NOT_ESCO_PKT_2EV5 | HCI_NOT_ESCO_PKT_3EV5)
#endif /* CSR_BT_HF_MSBC_DEFAULT_AUDIO_QUALITY */

#ifndef CSR_BT_HF_QCE_DEFAULT_AUDIO_QUALITY               /* EV3 + 2-EV5 + 3-EV5 */
#define CSR_BT_HF_QCE_DEFAULT_AUDIO_QUALITY               ((hci_pkt_type_t)HCI_ESCO_PKT_3EV3 | HCI_ESCO_PKT_2EV5 | HCI_ESCO_PKT_3EV5)
#endif /* CSR_BT_HF_QCE_DEFAULT_AUDIO_QUALITY */

#ifndef CSR_BT_HF_QCE_Q1_RX_TX_BANDWIDTH
#define CSR_BT_HF_QCE_Q1_RX_TX_BANDWIDTH                     16000
#endif /* CSR_BT_HF_QCE_QO_RX_TX_EFFORT */

#ifndef CSR_BT_HF_MSBC_MAX_LATENCY
#define CSR_BT_HF_MSBC_MAX_LATENCY                         0x000D
#endif /* CSR_BT_HF_MSBC_MAX_LATENCY */

#ifndef CSR_BT_HF_QCE_Q0_MAX_LATENCY
#define CSR_BT_HF_QCE_Q0_MAX_LATENCY                       0x000E
#endif /* CSR_BT_HF_QCE_Q0_MAX_LATENCY */

#ifndef CSR_BT_HF_QCE_Q1_MAX_LATENCY
#define CSR_BT_HF_QCE_Q1_MAX_LATENCY                       CSR_BT_HF_QCE_Q0_MAX_LATENCY
#endif /* CSR_BT_HF_QCE_Q1_MAX_LATENCY */

#ifndef CSR_BT_HF_QCE_Q2_MAX_LATENCY
#define CSR_BT_HF_QCE_Q2_MAX_LATENCY                       0x0013
#endif /* CSR_BT_HF_QCE_Q2_MAX_LATENCY */

#ifndef CSR_BT_HF_QCE_QO_VOICE_SETTINGS
#define CSR_BT_HF_QCE_QO_VOICE_SETTINGS                    CSR_BT_AIRCODING_TRANSPARENT_DATA
#endif /* CSR_BT_HF_QCE_QO_VOICE_SETTINGS */

#ifndef CSR_BT_HF_QCE_Q1_VOICE_SETTINGS
#define CSR_BT_HF_QCE_Q1_VOICE_SETTINGS                    CSR_BT_HF_QCE_QO_VOICE_SETTINGS
#endif /* CSR_BT_HF_QCE_Q1_VOICE_SETTINGS */

#ifndef CSR_BT_HF_QCE_Q2_VOICE_SETTINGS
#define CSR_BT_HF_QCE_Q2_VOICE_SETTINGS                    CSR_BT_HF_QCE_QO_VOICE_SETTINGS
#endif /* CSR_BT_HF_QCE_Q2_VOICE_SETTINGS */

#ifndef CSR_BT_HF_MSBC_DEFAULT_RE_TX_EFFORT
#define CSR_BT_HF_MSBC_DEFAULT_RE_TX_EFFORT                0x02
#endif /* CSR_BT_HF_MSBC_DEFAULT_RE_TX_EFFORT */

#ifndef CSR_BT_QCE_Q0_RETX_EFFORT
#define CSR_BT_QCE_Q0_RETX_EFFORT                          0x02
#endif /* CSR_BT_QCE_Q0_RETX_EFFORT */

#ifndef CSR_BT_QCE_Q1_RETX_EFFORT
#define CSR_BT_QCE_Q1_RETX_EFFORT                          CSR_BT_QCE_Q0_RETX_EFFORT
#endif /* CSR_BT_QCE_Q1_RETX_EFFORT */

#ifndef CSR_BT_QCE_Q2_RETX_EFFORT
#define CSR_BT_QCE_Q2_RETX_EFFORT                          CSR_BT_QCE_Q0_RETX_EFFORT
#endif /* CSR_BT_QCE_Q2_RETX_EFFORT */

/* Default audio accept parameters when CVSD codec selected,
 * includes S1, S2, S3, S4, D0 & D1 settings.                  */

/* Default CVSD : S1(EV3), S2(2-EV3), S3(2-EV3), S4(2-EV3), D0(HV1) & D1(HV3) settings to be used : 0x038D */
#ifndef CSR_BT_HF_CVSD_DEFAULT_AUDIO_QUALITY              /* HV1 + HV3 + EV3 + not 3-EV3 + not 2-EV5 + not 3-EV5 */
#define CSR_BT_HF_CVSD_DEFAULT_AUDIO_QUALITY               ((hci_pkt_type_t)HCI_ESCO_PKT_HV1 | HCI_ESCO_PKT_HV3 | HCI_ESCO_PKT_EV3 | HCI_NOT_ESCO_PKT_3EV3 | HCI_NOT_ESCO_PKT_2EV5 | HCI_NOT_ESCO_PKT_3EV5)
#endif /* CSR_BT_HF_CVSD_DEFAULT_AUDIO_QUALITY */

#ifndef CSR_BT_HF_CVSD_MAX_LATENCY
#define CSR_BT_HF_CVSD_MAX_LATENCY                         0x000C
#endif /* CSR_BT_HF_CVSD_MAX_LATENCY */

#ifndef CSR_BT_HF_DEFAULT_SERVER_HF
#define CSR_BT_HF_DEFAULT_SERVER_HF                        CSR_BT_CM_SERVER_CHANNEL_DONT_CARE
#endif

#ifndef CSR_BT_HF_DEFAULT_SERVER_HS
#define CSR_BT_HF_DEFAULT_SERVER_HS                        CSR_BT_CM_SERVER_CHANNEL_DONT_CARE
#endif
...
#else
#define CSR_BT_AV_SUPPORTED_FEATURES                                CSR_BT_AV_FEATURES_PLAYER
#endif
...
#define CSR_BT_AV_MAX_NUM_CONNECTIONS      2
...
/* Minimum encryption key size values for services */
#define CSR_BT_DUN_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_HANDSFREE_DEFAULT_ENC_KEY_SIZE_VAL                     ((CsrUint8) 0x07)

#define CSR_BT_BIP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_OPP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_SYNC_DEFAULT_ENC_KEY_SIZE_VAL                          ((CsrUint8) 0x07)

#define CSR_BT_MAP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_FTP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_SYNCML_DEFAULT_ENC_KEY_SIZE_VAL                        ((CsrUint8) 0x07)

#define CSR_BT_PBAP_DEFAULT_ENC_KEY_SIZE_VAL                          ((CsrUint8) 0x07)

#define CSR_BT_BPP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_SAP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x08)

#define CSR_BT_SPP_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_AV_DEFAULT_ENC_KEY_SIZE_VAL                            ((CsrUint8) 0x07)

#define CSR_BT_AVRCP_DEFAULT_ENC_KEY_SIZE_VAL                         ((CsrUint8) 0x07)

#define CSR_BT_HID_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_PAN_DEFAULT_ENC_KEY_SIZE_VAL                           ((CsrUint8) 0x07)

#define CSR_BT_HCRP_DEFAULT_ENC_KEY_SIZE_VAL                          ((CsrUint8) 0x07)

#define CSR_BT_MCAP_DEFAULT_ENC_KEY_SIZE_VAL                          ((CsrUint8) 0x07)

#define CSR_BT_GATT_DEFAULT_ENC_KEY_SIZE_VAL                          ((CsrUint8) 0x07)

#define CSR_BT_GNSS_DEFAULT_ENC_KEY_SIZE_VAL                          ((CsrUint8) 0x07)
...
#define DM_CONFIG_MODE_CHANGE_REMOTE_HOLDOFF_TIME           (2 * CSR_SCHED_SECOND)
#endif

/* Maximum size of data packets allowed from the controller in bytes */
#define DM_CONFIG_HOST_ACL_DATA_PACKET_LENGTH               ((CsrUint16)1691)
#define DM_CONFIG_HOST_TOTAL_NUM_ACL_DATA_PACKETS           20
...
* Defines for PXPM
*----------------------------------------------------------------------------*/
#define CSR_BT_PXPM_MAX_CONNECTIONS                         (8)     /* Range: 1-254 */

/* Default Scan parameters */
#define CSR_BT_PXPM_DEFAULT_SCAN_INTERVAL                   (CSR_BT_LE_DEFAULT_SCAN_INTERVAL)
#define CSR_BT_PXPM_DEFAULT_SCAN_WINDOW                     (CSR_BT_LE_DEFAULT_SCAN_WINDOW)

/* Default connection parameters */
#define CSR_BT_PXPM_DEFAULT_CONN_INTERVAL_MIN               (CSR_BT_LE_DEFAULT_CONN_INTERVAL_MIN)
#define CSR_BT_PXPM_DEFAULT_CONN_INTERVAL_MAX               (CSR_BT_LE_DEFAULT_CONN_INTERVAL_MAX)
#define CSR_BT_PXPM_DEFAULT_CONN_LATENCY                    (CSR_BT_LE_DEFAULT_CONN_LATENCY)
#define CSR_BT_PXPM_DEFAULT_CONN_SUPERVISION_TIMEOUT        (CSR_BT_LE_DEFAULT_CONN_SUPERVISION_TIMEOUT)

/* Aggressive connection parameters used during service discovery and configuration */
#define CSR_BT_PXPM_DEFAULT_SCAN_INTERVAL_FAST              (CSR_BT_LE_SCAN_INTERVAL_FAST)
#define CSR_BT_PXPM_DEFAULT_SCAN_WINDOW_FAST                (CSR_BT_LE_SCAN_WINDOW_FAST)
#define CSR_BT_PXPM_DEFAULT_CONN_INTERVAL_MIN_FAST          (CSR_BT_LE_CONNECTION_INTERVAL_MIN_FAST)
#define CSR_BT_PXPM_DEFAULT_CONN_INTERVAL_MAX_FAST          (CSR_BT_LE_CONNECTION_INTERVAL_MAX_FAST)
#define CSR_BT_PXPM_DEFAULT_CONN_LATENCY_FAST               (CSR_BT_LE_CONNECTION_LATENCY_FAST)
#define CSR_BT_PXPM_DEFAULT_CONN_SUPERVISION_TIMEOUT_FAST   (CSR_BT_LE_SUPERVISION_TIMEOUT_FAST)

/* Default Idle timeout(in the unit of 0.1 sec) used to maintain the lifetime of active connection */
#define CSR_BT_PXPM_DEFAULT_IDLE_TIMEOUT                    (0xFFFF) /* Never disconnect */

/* Default reconnection timeout(in the unit of 0.1 sec) used for linkloss reconnect timer */
#define CSR_BT_PXPM_DEFAULT_RECONNECT_TIMEOUT               (0x0000) /* Connect immediately */

/* Default read RSSI timeout(in the unit of 0.1 sec) for reading RSSI periodically */
#define CSR_BT_PXPM_DEFAULT_READ_RSSI_TIMEOUT               (0x0032) /* Read RSSI at every 5 sec */

/* Default RSSI delta value(in the unit dBm) to send RSSI indication to application */
#define CSR_BT_PXPM_DEFAULT_READ_RSSI_DELTA                 (10) /* Send RSSI Indication at every 10 dBm difference */

/* Default PXPM security requirements */
#define CSR_BT_PXPM_DEFAULT_SECURITY_REQUIREMENTS           (CSR_BT_GATT_SECURITY_FLAGS_UNAUTHENTICATED)


/*---------------------------------------------------------------------------
* Defines for FMP
*----------------------------------------------------------------------------*/
#define CSR_BT_FMP_MAX_CONNECTIONS                         (8)     /* Range: 1-254 */

/* Default Advertisement parameters */
#define CSR_BT_FMP_DEFAULT_ADV_INTERVAL_MIN                 (CSR_BT_LE_DEFAULT_ADV_INTERVAL_MIN)
#define CSR_BT_FMP_DEFAULT_ADV_INTERVAL_MAX                 (CSR_BT_LE_DEFAULT_ADV_INTERVAL_MAX)

/* Default Scan parameters */
#define CSR_BT_FMP_DEFAULT_SCAN_INTERVAL                    (CSR_BT_LE_DEFAULT_SCAN_INTERVAL)
#define CSR_BT_FMP_DEFAULT_SCAN_WINDOW                      (CSR_BT_LE_DEFAULT_SCAN_WINDOW)

/* Default connection parameters */
#define CSR_BT_FMP_DEFAULT_CONN_INTERVAL_MIN                (CSR_BT_LE_DEFAULT_CONN_INTERVAL_MIN)
#define CSR_BT_FMP_DEFAULT_CONN_INTERVAL_MAX                (CSR_BT_LE_DEFAULT_CONN_INTERVAL_MAX)
#define CSR_BT_FMP_DEFAULT_CONN_LATENCY                     (CSR_BT_LE_DEFAULT_CONN_LATENCY)
#define CSR_BT_FMP_DEFAULT_CONN_SUPERVISION_TIMEOUT         (CSR_BT_LE_DEFAULT_CONN_SUPERVISION_TIMEOUT)

/* Aggressive connection parameters used during service discovery and configuration */
#define CSR_BT_FMP_DEFAULT_CONN_INTERVAL_MIN_FAST           (CSR_BT_LE_CONNECTION_INTERVAL_MIN_FAST)
#define CSR_BT_FMP_DEFAULT_CONN_INTERVAL_MAX_FAST           (CSR_BT_LE_CONNECTION_INTERVAL_MAX_FAST)
#define CSR_BT_FMP_DEFAULT_CONN_LATENCY_FAST                (CSR_BT_LE_CONNECTION_LATENCY_FAST)

/* Default FMP security requirements */
#define CSR_BT_FMP_DEFAULT_SECURITY_REQUIREMENTS            (CSR_BT_GATT_SECURITY_FLAGS_UNAUTHENTICATED)

/*---------------------------------------------------------------------------
* Defines for LE SRV- Applicable for all LE Srv supported profiles
*----------------------------------------------------------------------------*/
/* Default reconnection timeout(in the unit of 0.1 sec) used for linkloss reconnect timer */
#define CSR_BT_LE_SRV_DEFAULT_RECONNECT_TIMEOUT             (0x0000) /* Connect immediately */
/* Default Security requirements */
#define CSR_BT_LE_SRV_DEFAULT_SECURITY_REQUIREMENTS         (CSR_BT_GATT_SECURITY_FLAGS_UNAUTHENTICATED)

/*---------------------------------------------------------------------------
* Defines for TPM
*----------------------------------------------------------------------------*/
#define CSR_BT_TPM_MAX_DEVICES                             (30)     /* Range: 1-254 */

/* Default Scan parameters */
#define CSR_BT_TPM_DEFAULT_SCAN_INTERVAL                   (CSR_BT_LE_DEFAULT_SCAN_INTERVAL)
#define CSR_BT_TPM_DEFAULT_SCAN_WINDOW                     (CSR_BT_LE_DEFAULT_SCAN_WINDOW)

/* Default connection parameters */
#define CSR_BT_TPM_DEFAULT_CONN_INTERVAL_MIN               (CSR_BT_LE_DEFAULT_CONN_INTERVAL_MIN)
#define CSR_BT_TPM_DEFAULT_CONN_INTERVAL_MAX               (CSR_BT_LE_DEFAULT_CONN_INTERVAL_MAX)
#define CSR_BT_TPM_DEFAULT_CONN_LATENCY                    (CSR_BT_LE_DEFAULT_CONN_LATENCY)
#define CSR_BT_TPM_DEFAULT_CONN_SUPERVISION_TIMEOUT        (CSR_BT_LE_DEFAULT_CONN_SUPERVISION_TIMEOUT)

/* Aggressive connection parameters used during service discovery and configuration */
#define CSR_BT_TPM_DEFAULT_SCAN_INTERVAL_FAST              (CSR_BT_LE_SCAN_INTERVAL_FAST)
#define CSR_BT_TPM_DEFAULT_SCAN_WINDOW_FAST                (CSR_BT_LE_SCAN_WINDOW_FAST)
#define CSR_BT_TPM_DEFAULT_CONN_INTERVAL_MIN_FAST          (CSR_BT_LE_CONNECTION_INTERVAL_MIN_FAST)
#define CSR_BT_TPM_DEFAULT_CONN_INTERVAL_MAX_FAST          (CSR_BT_LE_CONNECTION_INTERVAL_MAX_FAST)
#define CSR_BT_TPM_DEFAULT_CONN_LATENCY_FAST               (CSR_BT_LE_CONNECTION_LATENCY_FAST)
#define CSR_BT_TPM_DEFAULT_CONN_SUPERVISION_TIMEOUT_FAST   (CSR_BT_LE_SUPERVISION_TIMEOUT_FAST)

/* Default disconnect timeout(in the unit of 0.1 sec) used to maintain the lifetime of active connection */
#define CSR_BT_TPM_DEFAULT_DISCONNECT_TIMEOUT              (0xFFFF) /* Never disconnect */

/* Default TPM security requirements */
#define CSR_BT_TPM_DEFAULT_SECURITY_REQUIREMENTS           (CSR_BT_GATT_SECURITY_FLAGS_UNAUTHENTICATED)

/*---------------------------------------------------------------------------
* Defines for HIDD
*----------------------------------------------------------------------------*/
/* If HIDReconnectInitiate in SDP record is set to TRUE, HIDD will reconnect
 * with HID Host in case of an unexpected disconnection.
 * Following parameters determine the number of connection attempts and delay
 * between 2 connection attempts. */
#define HIDD_MAX_NUM_OF_RECONNECT_ATTEMPTS                 (60)
#define HIDD_RECONNECT_DELAY                               (500000) /* 500 milliseconds */
...
#define CM_LE_ADV_SET_RPA_CHANGE_TIMER_MIN    (CsrUint32)(420000)  /*Advertising time unit in ms representing 7 minutes */
#define CM_LE_ADV_SET_RPA_CHANGE_TIMER_MAX    (CsrUint32)(900000)  /*Advertising time unit in ms representing 15 minutes */
#endif
