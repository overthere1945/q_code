...
#define CSR_BT_GATT_READ_DEVICE_INFO_REQ          ((CsrBtGattPrim)(0x0002 + CSR_BT_GATT_PRIM_DOWNSTREAM_PRIVATE_LOWEST))
/*  Part of interface private interface, used internally by SC only */
#define CSR_BT_GATT_READ_REMOTE_LE_NAME_REQ       ((CsrBtGattPrim)(0x0003 + CSR_BT_GATT_PRIM_DOWNSTREAM_PRIVATE_LOWEST))
#define CSR_BT_GATT_READ_REMOTE_RPA_ONLY_CHAR_REQ ((CsrBtGattPrim)(0x0004 + CSR_BT_GATT_PRIM_DOWNSTREAM_PRIVATE_LOWEST))
...
#define CSR_BT_GATT_READ_REMOTE_RPA_ONLY_CHAR_CFM ((CsrBtGattPrim)(0x0001 + CSR_BT_GATT_PRIM_UPSTREAM_PRIVATE_LOWEST))
