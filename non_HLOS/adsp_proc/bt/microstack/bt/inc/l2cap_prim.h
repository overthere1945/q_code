...
/*! \name MTU and MPS defaults and parameters
  \{ */
#define L2CA_MTU_DEFAULT                672
#define L2CA_MTU_MINIMUM                48
#define L2CA_LE_MTU_MINIMUM             23
#define L2CA_ECBFC_MTU_MINIMUM          64
#define L2CA_ECBFC_MPS_MINIMUM          64
#define L2CA_ECBFC_MPS_MAXIMUM          65533
/*! \} */

/*! \name ECBFC max number of CIDs
  \{ */
#define L2CA_ECBFC_MAX_CIDS (5)
/*! \} */
...
#define L2CA_EXT_FEAT_ECBFC              0x0400 /*!< Enhanced Credit Based Flow Control Mode */
#define L2CA_EXT_FEAT_MAX                0x0400 /*!< Largest defined bit */
/*! \} */
...
#define L2CA_CID_AMP_TEST_MANGAGER       0x003F
...
/*
    As per spec valid dynamic max range of PSM would start from 0XFEFF, as we 
    want to reserve this range of PSM for internal use, the valid dynamic max 
    PSM range would start from 0xFCFF and lower.
*/
#define L2CA_PSM_DYNAMIC_MAX             L2CA_PSM_VALIDATE(0xFCFF)
...
/*! \name LE L2CAP Assigned CID range
  \{ */
#define L2CA_LE_CID_ASSIGNED_FIRST        0x0020
#define L2CA_LE_CID_ASSIGNED_LAST         0x003E
/*! \} */
...
#define L2CA_REGFLAG_USE_ECBFC          ((uint16_t)0x0010) /*!< Use Enhanced Credit Based Flow control
                                                                This flag shall be set along with L2CA_REGFLAG_USE_TP_PRIMS */
/*! \} */
...
/* Enhanced credit based flow control specific tags */
#define L2CA_AUTOPT_ECBFC_NUM_CONNS         ((uint16_t)0x0027) /* 16-bit, exact - number of connections in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_CID1              ((uint16_t)0x0028) /* 16-bit, exact - 1st CID in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_CID2              ((uint16_t)0x0029) /* 16-bit, exact - 2nd CID in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_CID3              ((uint16_t)0x002A) /* 16-bit, exact - 3rd CID in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_CID4              ((uint16_t)0x002B) /* 16-bit, exact - 4th CID in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_CID5              ((uint16_t)0x002C) /* 16-bit, exact - 5th CID in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_NUM_CONN_SUCCESS  ((uint16_t)0x002D) /* 16-bit, exact - Num CID (success) in enhanced credit based flow control*/
#define L2CA_AUTOPT_ECBFC_NUM_CONN_FAILURE  ((uint16_t)0x002E) /* 16-bit, exact - Num CID (failure) in enhanced credit based flow control*/
#define L2CA_AUTOPT_MPS_IN                  ((uint16_t)0x002F) /* 16 bit, exact - incoming MPS */
#define L2CA_AUTOPT_ECBFC                   ((uint16_t)0x0030) /* 16 bit, exact - use Enhanced credit based flow control mode */
/*! \} */
...
typedef uint16_t L2CA_RESULT_T;
#endif
...
#define L2CA_ENHANCED_CREDIT_CONRES_TABLE \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_SUCCESSFUL,                  = L2CA_RESULT_SUCCESS)                      L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_PSM_NOT_SUPPORTED,   = 0x0002)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_SOME_CONN_REFUSED_NO_RESOURCES,       = 0x0004)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_AUTHENTICATION,      = 0x0005)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_AUTHORIZATION,       = 0x0006)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_ENC_KEY_SIZE,        = 0x0007)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_ENCRYPTION,          = 0x0008)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_SOME_CONN_REFUSED_INVALID_SRC_CID,    = 0x0009)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_SOME_CONN_REFUSED_SRC_CID_INUSE,      = 0x000A)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_UNACCEPTABLE_PARAM,  = 0x000B)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_REFUSED_INVALID_PARAM,       = 0x000C)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_PENDING_INFO_UNAVAILABLE,    = 0x000D)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_PENDING_AUTHENTICATION,      = 0x000E)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ALL_CONN_PENDING_AUTHORIZATION,       = 0x000F)

#define L2CA_ENHANCED_CREDIT_RECONFRES_TABLE \
    L2CA_RES_TABLE_X(L2CA_ECBFC_RECONF_SUCCESSFUL,              = L2CA_RESULT_SUCCESS)                      L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ECBFC_RECONF_REJ_REDUCED_MTU,         = 0x0001)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ECBFC_RECONF_REJ_INVALID_REDUCED_MPS, = 0x0002)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ECBFC_RECONF_REJ_INVALID_DST_CID,     = 0x0003)                                   L2CA_RES_TABLE_SEP \
    L2CA_RES_TABLE_X(L2CA_ECBFC_RECONF_REJ_UNACCEPTABLE_PARAM,  = 0x0004)
...
{
    L2CA_CONRES_TABLE,
    L2CA_ENHANCED_CREDIT_CONRES_TABLE,
    L2CA_ENHANCED_CREDIT_RECONFRES_TABLE,
    L2CA_LE_CONRES_TABLE
#ifndef QBLUESTACK_RFCLI
} l2ca_conn_result_t;
#else
} l2ca_conn_result_enum_t;
typedef uint16_t l2ca_conn_result_t;
#endif
#undef L2CA_RES_TABLE_X
#undef L2CA_RES_TABLE_SEP
/*! \} */
...
#else
} l2ca_move_result_enum_t;
typedef uint16_t l2ca_move_result_t;
#endif
#undef L2CA_RES_TABLE_X
#undef L2CA_RES_TABLE_SEP
/*! \} */
...
#else
} l2ca_disc_result_enum_t;
typedef uint16_t l2ca_disc_result_t;
#endif
...
#else
} l2ca_conf_result_enum_t;
typedef uint16_t l2ca_conf_result_t;
#endif
#undef L2CA_RES_TABLE_X
#undef L2CA_RES_TABLE_SEP
/* \} */
...
#else
} l2ca_info_result_enum_t;
typedef uint16_t l2ca_info_result_t;
#endif
#undef L2CA_RES_TABLE_X
#undef L2CA_RES_TABLE_SEP
/*! \} */
...
#else
} l2ca_data_result_enum_t;
typedef uint16_t l2ca_data_result_t;
#endif
#undef L2CA_RES_TABLE_X
#undef L2CA_RES_TABLE_SEP
/* \} */
...
#else
}l2ca_misc_result_enum_t;
typedef uint16_t l2ca_misc_result_t;
#endif
#undef L2CA_RES_TABLE_X
#undef L2CA_RES_TABLE_SEP
/* \} */
...
#define L2CA_PING_RSP                   ((l2cap_prim_t)ENUM_L2CA_PING_RSP)
...
#define L2CA_PING_IND                   ((l2cap_prim_t)ENUM_L2CA_PING_IND)
...
typedef struct
{
    ...
    psm_t               psm_local;        /*!< Defines the PSM used by the entity registering with L2CAP 
                                               If the psm_local is L2CA_PSM_INVALID then the PSM is chosen from the 
                                               L2CA_PSM_DYNAMIC_MAX and lower. */
...
/*! \brief Register fixed CID request
    ...
    Following Fixed CID's are considered valid
        L2CA_CID_SIGNAL
        L2CA_CID_AMP_MANAGER
        L2CA_CID_ATTRIBUTE_PROTOCO
        L2CA_CID_LE_SIGNAL
        L2CA_CID_SECURITY_MANAGER
        L2CA_CID_BREDR_SECURITY_MANAGER
        L2CA_CID_AMP_TEST_MANGAGER

    Registering of the fixed-CID must happen before the related events
    could occur
    Ex: L2CA_CID_ATTRIBUTE_PROTOCO should be registered before 
    \ref L2CA_MAP_FIXED_CID_REQ_T, \ref L2CA_MAP_FIXED_CID_CFM_T and
    \ref L2CA_MAP_FIXED_CID_IND_T can be used.

    The application shall receive the L2CA_PING_IND post registering the 
    L2CA_CID_SIGNAL. If the application expects the L2CA_PING_IND immediately 
    after the connection, then it is advised to register the fixed CID before 
    the ACL connection.
...
/*! \brief L2CAP data indication
    ...
    Note:
    Over the connectionless channel, an application or profile which
    requires received data to be encrypted should ignore any unencrypted
    data received.
...
/*! \brief L2CAP ping request
    ...
    msc
    {
    Application,L2CAP,"Peer L2CAP","Peer DM","Peer Application";
                                     ---[ label="L2CAP SIGNAL CID Register" ];
    "Peer Application"->"Peer L2CAP"    [ label="L2CA_REGISTER_FIXED_CID_REQ(L2CAP_CID_SIGNAL)" ];
    "Peer L2CAP"->"Peer Application"    [ label="L2CA_REGISTER_FXIED_CID_CFM" ];
                                     ---[ label="BREDR Connection Established and Device added to SM-DB " ];
                                     ---[ label="Enable application to handle Ping req " ];
    "Peer Application"->"Peer DM"       [ label="DM_SET_LINK_BEHAVIOR_REQ(APP_HANDLE_L2CAP_ECHO, ENABLE)" ];
    "Peer DM"->"Peer Application"       [ label="DM_SET_LINK_BEHAVIOR_CFM" ];
                                     ---[ label="L2CAP Ping" ];
    Application->L2CAP                  [ label="L2CA_PING_REQ" ];
    L2CAP->"Peer L2CAP"                 [ label="L2CAP_ECHO_REQ" ];
    "Peer L2CAP"->"Peer Application"    [ label="L2CA_PING_IND" ];
    "Peer Application"->"Peer L2CAP"    [ label="L2CA_PING_RSP" ];
    "Peer L2CAP"->L2CAP                 [ label="L2CAP_ECHO_RSP" ];
    "L2CAP"->"Application"              [ label="L2CA_PING_CFM" ];
    
                                     ---[ label="Disable application to handle Ping req " ];
    "Peer Application"->"Peer DM"       [ label="DM_SET_LINK_BEHAVIOR_REQ(APP_HANDLE_L2CAP_ECHO, DISABLE)" ];
    "Peer DM"->"Peer Application"       [ label="DM_SET_LINK_BEHAVIOR_CFM" ];
                                     ---[ label="L2CAP Ping" ];
    Application->L2CAP                  [ label="L2CA_PING_REQ" ];
    L2CAP->"Peer L2CAP"                 [ label="L2CAP_ECHO_REQ" ];
...
typedef struct
{
    ...
    uint16_t            length;           /*!< number of bytes pointed to by data.
                                               Max allowed length is 44-octets, else 
                                               the data shall be trimmed.*/
...
/*! \brief L2CAP ping indication

    Ping request from remote device (echo request signal)
*/
typedef struct
{
    l2cap_prim_t        type;             /*!< Always L2CA_PING_IND */
    phandle_t           phandle;          /*!< destination handle */
    l2ca_identifier_t   identifier;       /*!< Used to identify the L2CAP_ECHO_REQ signal */
    BD_ADDR_T           bd_addr;          /*!< Bluetooth device address */
    uint16_t            length;           /*!< number of bytes pointed to by data */
    uint8_t            *data;             /*!< data received in echo request */
} L2CA_PING_IND_T;

/*! \brief L2CAP ping response

    Ping response to the remote device (sends echo response signal).
*/
typedef struct
{
    l2cap_prim_t        type;             /*!< Always L2CA_PING_RSP */
    l2ca_identifier_t   identifier;       /*!< Same as identifier in L2CA_PING_IND */
    BD_ADDR_T           bd_addr;          /*!< Bluetooth device address */
    uint16_t            length;           /*!< number of bytes pointed to by data.
                                               Max allowed length is 44-octets, else 
                                               the data shall be trimmed. */
    uint8_t            *data;             /*!< data to be sent via echo response */
} L2CA_PING_RSP_T;
...
typedef union
{
    ...
    L2CA_PING_RSP_T                     l2ca_ping_rsp;                  /*!< See \ref L2CA_PING_RSP_T */
    ...
    L2CA_PING_IND_T                     l2ca_ping_ind;                  /*!< See \ref L2CA_PING_IND_T */
