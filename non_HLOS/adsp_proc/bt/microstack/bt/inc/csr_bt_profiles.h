...
************************************************************************************/
#define CSR_BT_SC_DEFAULT_ENC_KEY_SIZE            ((CsrUint8) 0x07)
...
#define CSR_BT_DG_PRIM                            ((CsrPrim)(0x0100))
#define CSR_BT_DUNC_PRIM                          ((CsrPrim)(0x0101))
#define CSR_BT_SC_PRIM                            ((CsrPrim)(0x0102))
#define CSR_BT_CM_PRIM                            ((CsrPrim)(0x0104))
#define CSR_BT_SDS_PRIM                           ((CsrPrim)(0x0105))
#define CSR_BT_OPS_PRIM                           ((CsrPrim)(0x0106))
#define CSR_BT_OPC_PRIM                           ((CsrPrim)(0x0107))
#define CSR_BT_AT_PRIM                            ((CsrPrim)(0x0108))
#define CSR_BT_IWU_PRIM                           ((CsrPrim)(0x0109))
#define CSR_BT_SYNCS_PRIM                         ((CsrPrim)(0x010A))
#define CSR_BT_SPP_PRIM                           ((CsrPrim)(0x010B))
#define CSR_BT_FAX_PRIM                           ((CsrPrim)(0x010C))
#define CSR_BT_HFG_PRIM                           ((CsrPrim)(0x010D))
#define CSR_BT_HF_PRIM                            ((CsrPrim)(0x010E))
#define CSR_BT_FTS_PRIM                           ((CsrPrim)(0x0110))
#define CSR_BT_BNEP_PRIM                          ((CsrPrim)(0x0111))
#define CSR_BT_BSL_PRIM                           ((CsrPrim)(0x0112))
#define CSR_BT_BIPS_PRIM                          ((CsrPrim)(0x0113))
#define CSR_BT_BIPC_PRIM                          ((CsrPrim)(0x0114))
#define CSR_BT_FTC_PRIM                           ((CsrPrim)(0x0115))
#define CSR_BT_SMLC_PRIM                          ((CsrPrim)(0x0116))
#define CSR_BT_SMLS_PRIM                          ((CsrPrim)(0x0117))
#define CSR_BT_PPP_PRIM                           ((CsrPrim)(0x0118))
#define CSR_BT_BPPC_PRIM                          ((CsrPrim)(0x0119))
#define CSR_BT_AV_PRIM                            ((CsrPrim)(0x011A))
#define CSR_BT_AVRCP_PRIM                         ((CsrPrim)(0x011B))
#define CSR_BT_SAPS_PRIM                          ((CsrPrim)(0x011C))
#define CSR_BT_SAPC_PRIM                          ((CsrPrim)(0x011D))
#define CSR_BT_SD_PRIM                            ((CsrPrim)(0x011E))
#define CSR_BT_HIDH_PRIM                          ((CsrPrim)(0x011F))
#define CSR_BT_HIDD_PRIM                          ((CsrPrim)(0x0120))
#define CSR_BT_PAS_PRIM                           ((CsrPrim)(0x0121))
#define CSR_BT_PAC_PRIM                           ((CsrPrim)(0x0122))
#define CSR_BT_BPPS_PRIM                          ((CsrPrim)(0x0123))
#define CSR_BT_LSL_PRIM                           ((CsrPrim)(0x0124))
#define CSR_BT_HCRP_PRIM                          ((CsrPrim)(0x0125))
#define CSR_BT_JSR82_PRIM                         ((CsrPrim)(0x0126))
#define CSR_BT_SDC_PRIM                           ((CsrPrim)(0x0128))
#define CSR_BT_SYNCC_PRIM                         ((CsrPrim)(0x0129))
#define CSR_BT_MCAP_PRIM                          ((CsrPrim)(0x012A))
#define CSR_BT_HDP_PRIM                           ((CsrPrim)(0x012B))
#define CSR_BT_MAPC_PRIM                          ((CsrPrim)(0x012C))
#define CSR_BT_MAPS_PRIM                          ((CsrPrim)(0x012D))
#define CSR_BT_AMPM_PRIM                          ((CsrPrim)(0x012E))
#define CSR_BT_PHDC_MGR_PRIM                      ((CsrPrim)(0x012F))
#define CSR_BT_PHDC_AG_PRIM                       ((CsrPrim)(0x0130))
#define CSR_BT_GATT_PRIM                          ((CsrPrim)(0x0131))
#define CSR_BT_PROX_SRV_PRIM                      ((CsrPrim)(0x0132))
#define CSR_BT_THERM_SRV_PRIM                     ((CsrPrim)(0x0133))
#define CSR_BT_GENERIC_SRV_PRIM                   ((CsrPrim)(0x0134))
#define CSR_BT_GNSS_CLIENT_PRIM                   ((CsrPrim)(0x0135))
#define CSR_BT_GNSS_SERVER_PRIM                   ((CsrPrim)(0x0136))
#define CSR_BT_ASM_PRIM                           ((CsrPrim)(0x0137))
#define CSR_BT_AVRCP_IMAGING_PRIM                 ((CsrPrim)(0x0138))
#define CSR_BT_HOGH_PRIM                          ((CsrPrim)(0x0139))
#define CSR_BT_PXPM_PRIM                          ((CsrPrim)(0x013A))
#define CSR_BT_LE_SRV_PRIM                        ((CsrPrim)(0x013B))
#define CSR_BT_LE_SVC_PRIM                        ((CsrPrim)(0x013C))
#define CSR_BT_LPM_PRIM                           ((CsrPrim)(0x013D))
#define CSR_BT_TPM_PRIM                           ((CsrPrim)(0x013E))
#define CSR_BT_GGPROXY_PRIM                       ((CsrPrim)(0x013F))
#define BAP_PRIM                                  ((CsrPrim)(0x0140))
#define ASCS_CLIENT_PRIM                          ((CsrPrim)(0x0141))
#define PACS_CLIENT_PRIM                          ((CsrPrim)(0x0142))
#define GATT_SRVC_DISC_PRIM                       ((CsrPrim)(0x0143))
#define CSR_BT_SYNERGY_AG                         ((CsrPrim)(0x0144))
#define VCP_PRIM                                  ((CsrPrim)(0x0145))
#define VCS_CLIENT_PRIM                           ((CsrPrim)(0x0146))
#define VOCS_CLIENT_PRIM                          ((CsrPrim)(0x0147))
#define AICS_CLIENT_PRIM                          ((CsrPrim)(0x0148))
#define PACS_SERVER_PRIM                          ((CsrPrim)(0x0149))
#define VCS_SERVER_PRIM                           ((CsrPrim)(0x014A))
#define ASCS_SERVER_PRIM                          ((CsrPrim)(0x014B))
#define CSIP_PRIM                                 ((CsrPrim)(0x014C))
#define CSIS_CLIENT_PRIM                          ((CsrPrim)(0x014D))
#define TBS_SERVER_PRIM                           ((CsrPrim)(0x014E))
#define BASS_CLIENT_PRIM                          ((CsrPrim)(0x014F))
#define TBS_CLIENT_PRIM                           ((CsrPrim)(0x0150))
#define CSIS_SERVER_PRIM                          ((CsrPrim)(0x0151))
#define BASS_SERVER_PRIM                          ((CsrPrim)(0x0152))
#define MCS_CLIENT_PRIM                           ((CsrPrim)(0x0153))
#define MCP_PRIM                                  ((CsrPrim)(0x0154))
#define MCS_SERVER_PRIM                           ((CsrPrim)(0x0155))
#define CTM_PRIM                                  ((CsrPrim)(0x0156))
#define MICS_SERVER_PRIM                          ((CsrPrim)(0x0157))
#define BAP_SERVER_PRIM                           ((CsrPrim)(0x0158))
#define WMAS_SERVER_PRIM                          ((CsrPrim)(0x0159))
#define GMAS_SERVER_PRIM                          ((CsrPrim)(0x015A))
#define CAS_SERVER_PRIM                           ((CsrPrim)(0x015B))
#define CCP_PRIM                                  ((CsrPrim)(0x015C))
#define BAS_SERVER_PRIM                           ((CsrPrim)(0x015D))
#define DIS_SERVER_PRIM                           ((CsrPrim)(0x015E))
#define TPS_SERVER_PRIM                           ((CsrPrim)(0x015F))
#define TDS_SERVER_PRIM                           ((CsrPrim)(0x0160))
#define TDS_CLIENT_PRIM                           ((CsrPrim)(0x0161))
#define CHP_SEEKER_PRIM                           ((CsrPrim)(0x0162))
#define TMAS_CLIENT_PRIM                          ((CsrPrim)(0x0163))
#define TMAP_CLIENT_PRIM                          ((CsrPrim)(0x0164))
#define TMAS_SERVER_PRIM                          ((CsrPrim)(0x0165))
#define CAP_CLIENT_PRIM                           ((CsrPrim)(0x0166))
#define BT_VSDM_PRIM                              ((CsrPrim)(0x0167))
#define MICP_PRIM                                 ((CsrPrim)(0x016A))
#define MICS_CLIENT_PRIM                          ((CsrPrim)(0x016B))
#define PBP_PRIM                                  ((CsrPrim)(0x016C))
#define GMAS_CLIENT_PRIM                          ((CsrPrim)(0x016D))
#define GMAP_CLIENT_PRIM                          ((CsrPrim)(0x016E))
#define HIDS_SERVER_PRIM                          ((CsrPrim)(0x016F))
#define QSS_SERVER_PRIM                           ((CsrPrim)(0x0170))
#define MS_ADV_SCAN_PRIM                          ((CsrPrim)(0x0171))
#define HCI_CMD_ARB_PRIM                          ((CsrPrim)(0x0172))
#define HCI_ATT_ARB_PRIM                          ((CsrPrim)(0x0173))


#define CSR_BT_NUMBER_OF_CSR_BT_EVENTS            (0x0171 - CSR_BT_CPL_PRIM_BASE + 1)
...
#define CSR_BT_CONN_ID_CANCELLED           ((CsrBtConnId) 0x80000000u)
...
/* Max value for unsigned integers */
...
#define CSR_BT_UUID_GET_UUID16_FROM_UUID32_ARRAY(uuid32)                     \
        (CsrUint16) ((uuid32[0] & 0x000000FF) | (uuid32[0] & 0x0000FF00))

#define CSR_BT_UUID_GET_UUID128_FROM_UUID32_ARRAY(uuid128, uuid32)           \
    do                                                                       \
    {                                                                        \
        CSR_COPY_UINT32_TO_LITTLE_ENDIAN(uuid32[0], &(uuid128.uuid[12]));    \
        CSR_COPY_UINT32_TO_LITTLE_ENDIAN(uuid32[1], &(uuid128.uuid[8]));     \
        CSR_COPY_UINT32_TO_LITTLE_ENDIAN(uuid32[2], &(uuid128.uuid[4]));     \
        CSR_COPY_UINT32_TO_LITTLE_ENDIAN(uuid32[3], (uuid128.uuid));         \
    } while (0)
...
#define CSR_BT_LINK_STATUS_DISCONNECTED                   0x03
#define CSR_BT_LINK_STATUS_MAX_RECONNECT_TIME             0x04
...
#define BT_EIR_DATA_TYPE_ENCRYPTED_ADVERTISING_DATA         (0x31)
...
#define CSR_BT_GATT_SERVICE_CHANGED_DESCRIPTOR_HANDLE_MASK                           0xFFFF0000u
...
extern void *CsrBtFreeUpstreamMessageContents(CsrUint16 eventClass, void *message);
