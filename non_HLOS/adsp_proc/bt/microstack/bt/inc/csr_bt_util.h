...
extern void SetBdAddrInvalid(BD_ADDR_T *bdAddr);
...
typedef CsrBool (*QapiEventCallback)(CsrUint16 q, CsrUint16 mi, void *mv);
void QapiBtHostInit(QapiEventCallback eventCb);
