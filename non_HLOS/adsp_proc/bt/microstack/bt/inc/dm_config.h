...
#if defined INSTALL_CONTROLLER_TO_HOST_FLOW_CONTROL && defined BLUESTACK_HOST_IS_APPS
#ifndef DM_CONFIG_HOST_ACL_DATA_PACKET_LENGTH
#define DM_CONFIG_HOST_ACL_DATA_PACKET_LENGTH           ((uint16_t)512)
#endif
/* Usable size of ACL Rx buffer in transport BT module.
 * Hydra APPS MMU buffer reserves one MMU page space 
 * for buffer management. This space must be adjusted 
 * from total buffer size.
 */
#define DM_CONFIG_HOST_ACL_RX_BUFFER_SIZE               (ACL_RX_BUFFER_SIZE - (1U << MMU_LOG_PAGE_BYTES)) 
#ifndef DM_CONFIG_HOST_TOTAL_NUM_ACL_DATA_PACKETS
#define DM_CONFIG_HOST_TOTAL_NUM_ACL_DATA_PACKETS       ((uint16_t)(DM_CONFIG_HOST_ACL_RX_BUFFER_SIZE/DM_CONFIG_HOST_ACL_DATA_PACKET_LENGTH))
#endif

#else  /* INSTALL_CONTROLLER_TO_HOST_FLOW_CONTROL */
/* Default Synergy from-chip buffer configuration */
#ifndef DM_CONFIG_HOST_ACL_DATA_PACKET_LENGTH
#define DM_CONFIG_HOST_ACL_DATA_PACKET_LENGTH           ((uint16_t)1021)
#endif
#ifndef DM_CONFIG_HOST_TOTAL_NUM_ACL_DATA_PACKETS
#define DM_CONFIG_HOST_TOTAL_NUM_ACL_DATA_PACKETS       ((uint16_t)100)
#endif
#endif /* INSTALL_CONTROLLER_TO_HOST_FLOW_CONTROL */

#ifndef DM_CONFIG_HOST_SCO_DATA_PACKET_LENGTH
#define DM_CONFIG_HOST_SCO_DATA_PACKET_LENGTH           ((uint8_t) 128)
#endif
#ifndef DM_CONFIG_HOST_TOTAL_NUM_SCO_DATA_PACKETS
#define DM_CONFIG_HOST_TOTAL_NUM_SCO_DATA_PACKETS       ((uint16_t)16)
#endif
#endif /* BUILD_FOR_HOST */

#define DM_MAX_NUM_DEVICES_IN_BLACK_LIST                (uint8_t)5

#ifndef DM_CONFIG_POWERUP_TIMEOUT
#define DM_CONFIG_POWERUP_TIMEOUT                       (5 * SECOND)
#endif
...
#define DM_CONFIG_SM_DETACH_TIMEOUT                     (2 * SECOND)
#endif
...
#define DM_CONFIG_SM_REAUTHENTICATION_TIMEOUT           (1 * SECOND)
#endif
...
#define DM_CONFIG_SM_REENCRYPTION_TIMEOUT               (200 * MILLISECOND)
#endif
...
#define DM_CONFIG_MODE_CHANGE_FAILED_HOLDOFF_TIME       (1 * SECOND)
#endif
#ifndef DM_CONFIG_MODE_CHANGE_REMOTE_HOLDOFF_TIME
#define DM_CONFIG_MODE_CHANGE_REMOTE_HOLDOFF_TIME       (2 * SECOND)
#endif

/* Basic unit of ACL idle timeout used internally by ACL Manager. */
#ifndef DM_CONFIG_ACL_IDLE_TIMEOUT_BASE
#define DM_CONFIG_ACL_IDLE_TIMEOUT_BASE                 (250 * MILLISECOND)
#endif
...
#define DM_CONFIG_ACL_IDLE_TIMEOUT_SHORT    ((2*SECOND)/DM_CONFIG_ACL_IDLE_TIMEOUT_BASE)    /* Wait for 2 seconds. */
#endif

/* Timeout to allow for rapid user interaction - YES/NO option. */
#ifndef DM_CONFIG_ACL_IDLE_TIMEOUT_MEDIUM
#define DM_CONFIG_ACL_IDLE_TIMEOUT_MEDIUM   ((10*SECOND)/DM_CONFIG_ACL_IDLE_TIMEOUT_BASE)   /* Wait for 10 seconds. */
#endif
...
#define DM_CONFIG_ACL_IDLE_TIMEOUT_LONG     ((30*SECOND)/DM_CONFIG_ACL_IDLE_TIMEOUT_BASE)   /* Wait for 30 seconds. */
#endif
...
#define DM_CONFIG_ACL_IDLE_TIMEOUT_LE_PAIRING    ((2*SECOND)/DM_CONFIG_ACL_IDLE_TIMEOUT_BASE)    /* Wait for 2 seconds. */
#endif
...
/* In case ACL disconnect attempt failed for disallowed re-issue the command */
#ifndef DM_CONFIG_ACL_DISCONNECT_REATTEMPT_TIMEOUT
#define DM_CONFIG_ACL_DISCONNECT_REATTEMPT_TIMEOUT (10*MILLISECOND)
#endif
