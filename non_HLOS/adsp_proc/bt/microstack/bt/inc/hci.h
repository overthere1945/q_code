/*******************************************************************************
        ...
        Copyright (c) 2001-2024 Qualcomm Technologies International, Ltd.
        All Rights Reserved.
...
/******************************************************************************
   ...
   NOTE: Try to keep on a modulo 2 boundary to reduce the performance overhead of
   performing division and remainder operations.  The compiler will optimise to shift operators
   which are a lot faster.  These are used in the processing of advertising data reports.
 *****************************************************************************/
...
#define HCI_CONFIGURE_DATA_PATH                         ((hci_op_code_t)HCI_HOST_BB | 0x0083)
#define HCI_SET_MIN_ENCRYPTION_KEY_SIZE                 ((hci_op_code_t)HCI_HOST_BB | 0x0084)

#define HCI_MAX_HOST_BB_OCF            ((hci_op_code_t) 0x0085)
...
#define HCI_ULP_EXT_ADV_SET_RANDOM_ADDR                   ((hci_op_code_t)HCI_ULP | 0x0035)
#define HCI_ULP_EXT_ADV_SET_PARAMS                        ((hci_op_code_t)HCI_ULP | 0x0036)
#define HCI_ULP_EXT_ADV_SET_DATA                          ((hci_op_code_t)HCI_ULP | 0x0037)
#define HCI_ULP_EXT_ADV_SET_SCAN_RESP_DATA                ((hci_op_code_t)HCI_ULP | 0x0038)
#define HCI_ULP_EXT_ADV_ENABLE                            ((hci_op_code_t)HCI_ULP | 0x0039)
#define HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN             ((hci_op_code_t)HCI_ULP | 0x003a)
#define HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS              ((hci_op_code_t)HCI_ULP | 0x003b)
#define HCI_ULP_EXT_ADV_REMOVE_ADV_SET                    ((hci_op_code_t)HCI_ULP | 0x003c)
#define HCI_ULP_EXT_ADV_CLEAR_ADV_SETS                    ((hci_op_code_t)HCI_ULP | 0x003d)

/* Periodic Advertising (PA) */
#define HCI_ULP_PERIODIC_ADV_SET_PARAMS                   ((hci_op_code_t)HCI_ULP | 0x003e)
#define HCI_ULP_PERIODIC_ADV_SET_DATA                     ((hci_op_code_t)HCI_ULP | 0x003f)
#define HCI_ULP_PERIODIC_ADV_ENABLE                       ((hci_op_code_t)HCI_ULP | 0x0040)

/* Extended Scanning (ES) */
#define HCI_ULP_EXT_SCAN_SET_PARAMS                       ((hci_op_code_t)HCI_ULP | 0x0041)
#define HCI_ULP_EXT_SCAN_ENABLE                           ((hci_op_code_t)HCI_ULP | 0x0042)
#define HCI_ULP_EXT_SCAN_CREATE_CONNECTION                ((hci_op_code_t)HCI_ULP | 0x0043)

/* Periodic Scanning (PS) */
#define HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN               ((hci_op_code_t)HCI_ULP | 0x0044)
#define HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_CANCEL        ((hci_op_code_t)HCI_ULP | 0x0045)
#define HCI_ULP_PERIODIC_SCAN_SYNC_TERMINATE              ((hci_op_code_t)HCI_ULP | 0x0046)
#define HCI_ULP_PERIODIC_SCAN_ADD_DEVICE_TO_PA_LIST       ((hci_op_code_t)HCI_ULP | 0x0047)
#define HCI_ULP_PERIODIC_SCAN_REMOVE_DEVICE_FROM_PA_LIST  ((hci_op_code_t)HCI_ULP | 0x0048)
#define HCI_ULP_PERIODIC_SCAN_CLEAR_PA_LIST               ((hci_op_code_t)HCI_ULP | 0x0049)
#define HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE           ((hci_op_code_t)HCI_ULP | 0x004a)

#define HCI_ULP_SET_PRIVACY_MODE                          ((hci_op_code_t)HCI_ULP | 0x004e)

/* Periodic Scanning (PS) */
#define HCI_ULP_PERIODIC_SCAN_SYNC_REPORT_PERIODIC        ((hci_op_code_t)HCI_ULP | 0x0059)

/* Periodic Advertising Sync Transfer (PAST) */
#define HCI_ULP_PERIODIC_ADV_SYNC_TRANSFER                ((hci_op_code_t)HCI_ULP | 0x005a)
#define HCI_ULP_PERIODIC_ADV_SET_INFO_TRANSFER            ((hci_op_code_t)HCI_ULP | 0x005b)
#define HCI_ULP_PERIODIC_ADV_SET_SYNC_TRANSFER_PARAMS     ((hci_op_code_t)HCI_ULP | 0x005c)
#define HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS       ((hci_op_code_t)HCI_ULP | 0x005d)

/* Isochronous commands */
#define HCI_ULP_SET_CIG_PARAMETERS                        ((hci_op_code_t)HCI_ULP | 0x0062)
#define HCI_ULP_SET_CIG_PARAMETERS_TEST                   ((hci_op_code_t)HCI_ULP | 0x0063)
#define HCI_ULP_CREATE_CIS                                ((hci_op_code_t)HCI_ULP | 0x0064)
#define HCI_ULP_REMOVE_CIG                                ((hci_op_code_t)HCI_ULP | 0x0065)
#define HCI_ULP_ACCEPT_CIS_REQUEST                        ((hci_op_code_t)HCI_ULP | 0x0066)
#define HCI_ULP_REJECT_CIS_REQUEST                        ((hci_op_code_t)HCI_ULP | 0x0067)
#define HCI_ULP_CREATE_BIG                                ((hci_op_code_t)HCI_ULP | 0x0068)
#define HCI_ULP_CREATE_BIG_TEST                           ((hci_op_code_t)HCI_ULP | 0x0069)
#define HCI_ULP_TERMINATE_BIG                             ((hci_op_code_t)HCI_ULP | 0x006A)
#define HCI_ULP_BIG_CREATE_SYNC                           ((hci_op_code_t)HCI_ULP | 0x006B)
#define HCI_ULP_BIG_TERMINATE_SYNC                        ((hci_op_code_t)HCI_ULP | 0x006C)
#define HCI_ULP_REQUEST_PEER_SCA                          ((hci_op_code_t)HCI_ULP | 0x006D)
#define HCI_ULP_SETUP_ISO_DATA_PATH                       ((hci_op_code_t)HCI_ULP | 0x006E)
#define HCI_ULP_REMOVE_ISO_DATA_PATH                      ((hci_op_code_t)HCI_ULP | 0x006F)
#define HCI_ULP_ISO_TRANSMIT_TEST                         ((hci_op_code_t)HCI_ULP | 0x0070)
#define HCI_ULP_ISO_RECEIVE_TEST                          ((hci_op_code_t)HCI_ULP | 0x0071)
#define HCI_ULP_ISO_READ_TEST_COUNTERS                    ((hci_op_code_t)HCI_ULP | 0x0072)
#define HCI_ULP_SET_HOST_FEATURE                          ((hci_op_code_t)HCI_ULP | 0x0074)
#define HCI_ULP_READ_ISO_LINK_QUALITY                     ((hci_op_code_t)HCI_ULP | 0x0075)

/* LE power control commands */
#define HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL        ((hci_op_code_t)HCI_ULP | 0x0076)
#define HCI_ULP_READ_REMOTE_TRANSMIT_POWER_LEVEL          ((hci_op_code_t)HCI_ULP | 0x0077)
#define HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS        ((hci_op_code_t)HCI_ULP | 0x0078)
#define HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE            ((hci_op_code_t)HCI_ULP | 0x0079)
#define HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE       ((hci_op_code_t)HCI_ULP | 0x007A)

/* LE advertising change address when data set */
#define HCI_ULP_SET_DATA_RELATED_ADDRESS_CHANGES          ((hci_op_code_t)HCI_ULP | 0x007C)

/* Subrate commands */
#define HCI_ULP_SET_DEFAULT_SUBRATE                       ((hci_op_code_t)HCI_ULP | 0x007D)
#define HCI_ULP_SUBRATE_REQUEST                           ((hci_op_code_t)HCI_ULP | 0x007E)

#define HCI_ULP_EXT_ADV_SET_PARAMS_V2                     ((hci_op_code_t)HCI_ULP | 0x007F)

#define HCI_MAX_ULP_OCF                                   ((hci_op_code_t)0x0080)
...
#define HCI_EV_ENCRYPTION_CHANGE_V2                  ((hci_event_code_t)0x59)

#define HCI_MAX_EVENT_OPCODE                         ((hci_event_code_t)0x60)
...
#define HCI_EV_ULP_CIS_ESTABLISHED                     ((hci_event_code_t)0x19)
#define HCI_EV_ULP_CIS_REQUEST                         ((hci_event_code_t)0x1A)
#define HCI_EV_ULP_CREATE_BIG_COMPLETE                 ((hci_event_code_t)0x1B)
#define HCI_EV_ULP_TERMINATE_BIG_COMPLETE              ((hci_event_code_t)0x1C)
#define HCI_EV_ULP_BIG_SYNC_ESTABLISHED                ((hci_event_code_t)0x1D)
#define HCI_EV_ULP_BIG_SYNC_LOST                       ((hci_event_code_t)0x1E)
#define HCI_EV_ULP_REQUEST_PEER_SCA_COMPLETE           ((hci_event_code_t)0x1F)
/* LE power control events */
#define HCI_EV_ULP_PATH_LOSS_THRESHOLD                 ((hci_event_code_t)0x20)
#define HCI_EV_ULP_TRANSMIT_POWER_REPORTING            ((hci_event_code_t)0x21)
#define HCI_EV_ULP_BIGINFO_ADV_REPORT                  ((hci_event_code_t)0x22)
#define HCI_EV_ULP_SUBRATE_CHANGE                      ((hci_event_code_t)0x23)
...
#define HCI_SET_MIN_ENCRYPTION_KEY_SIZE_LEN                   ((uint8_t) 1)
...
#define HCI_CONFIGURE_DATA_PATH_PARAM_LEN                ((uint8_t) 3) /* Variable */
...
#define HCI_ULP_SET_DATA_RELATED_ADDRESS_CHANGES_PARAM_LEN          ((uint8_t)  2)
#define HCI_ULP_EXT_ADV_SET_RANDOM_ADDR_PARAM_LEN                   ((uint8_t)  7)
#define HCI_ULP_EXT_ADV_SET_PARAMS_PARAM_LEN                        ((uint8_t) 25)
#define HCI_ULP_EXT_ADV_SET_PARAMS_V2_PARAM_LEN                     ((uint8_t) 27)
#define HCI_ULP_EXT_ADV_SET_DATA_PARAM_LEN                          ((uint8_t)  4) /* Variable */
#define HCI_ULP_EXT_ADV_SET_SCAN_RESP_DATA_PARAM_LEN                ((uint8_t)  4) /* Variable */
#define HCI_ULP_EXT_ADV_ENABLE_PARAM_LEN                            ((uint8_t)  6) /* Variable */
#define HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN_PARAM_LEN             ((uint8_t)  0)
#define HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS_PARAM_LEN              ((uint8_t)  0)
#define HCI_ULP_EXT_ADV_REMOVE_ADV_SET_PARAM_LEN                    ((uint8_t)  1)
#define HCI_ULP_EXT_ADV_CLEAR_ADV_SETS_PARAM_LEN                    ((uint8_t)  0)
#define HCI_ULP_PERIODIC_ADV_SET_PARAMS_PARAM_LEN                   ((uint8_t)  7)
#define HCI_ULP_PERIODIC_ADV_SET_DATA_PARAM_LEN                     ((uint8_t)  3) /* Variable */
#define HCI_ULP_PERIODIC_ADV_ENABLE_PARAM_LEN                       ((uint8_t)  2)
#define HCI_ULP_EXT_SCAN_SET_PARAMS_PARAM_LEN                       ((uint8_t)  8) /* Variable */
#define HCI_ULP_EXT_SCAN_ENABLE_PARAM_LEN                           ((uint8_t)  6)
#define HCI_ULP_EXT_SCAN_CREATE_CONNECTION_PARAM_LEN                ((uint8_t) 26) /* Variable */
#define HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_PARAM_LEN               ((uint8_t) 14)
#define HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_CANCEL_PARAM_LEN        ((uint8_t)  0)
#define HCI_ULP_PERIODIC_SCAN_SYNC_TERMINATE_PARAM_LEN              ((uint8_t)  2)
#define HCI_ULP_PERIODIC_SCAN_ADD_DEVICE_TO_PA_LIST_PARAM_LEN       ((uint8_t)  8)
#define HCI_ULP_PERIODIC_SCAN_REMOVE_DEVICE_FROM_PA_LIST_PARAM_LEN  ((uint8_t)  8)
#define HCI_ULP_PERIODIC_SCAN_CLEAR_PA_LIST_PARAM_LEN               ((uint8_t)  0)
#define HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE_PARAM_LEN           ((uint8_t)  0)
#define HCI_ULP_PERIODIC_SCAN_SYNC_REPORT_PERIODIC_PARAM_LEN        ((uint8_t)  3)
#define HCI_ULP_PERIODIC_ADV_SYNC_TRANSFER_PARAM_LEN                ((uint8_t)  6)
#define HCI_ULP_PERIODIC_ADV_SET_INFO_TRANSFER_PARAM_LEN            ((uint8_t)  5)
#define HCI_ULP_PERIODIC_ADV_SET_SYNC_TRANSFER_PARAMS_PARAM_LEN     ((uint8_t)  8)
...
#define HCI_ULP_REQUEST_PEER_SCA_PARAM_LEN                          ((uint8_t)  2)
#define HCI_ULP_SET_CIG_PARAMETERS_PARAM_LEN                        ((uint8_t) 15) /* Variable */
#define HCI_ULP_SET_CIG_PARAMETERS_TEST_PARAM_LEN                   ((uint8_t) 15) /* Variable */
#define HCI_ULP_REMOVE_CIG_PARAM_LEN                                ((uint8_t)  1)
#define HCI_ULP_CREATE_CIS_PARAM_LEN                                ((uint8_t)  5) /* Variable */
#define HCI_ULP_ACCEPT_CIS_REQUEST_PARAM_LEN                        ((uint8_t)  2)
#define HCI_ULP_REJECT_CIS_REQUEST_PARAM_LEN                        ((uint8_t)  3)
#define HCI_ULP_CREATE_BIG_PARAM_LEN                                ((uint8_t) 31)
#define HCI_ULP_CREATE_BIG_TEST_PARAM_LEN                           ((uint8_t) 36)
#define HCI_ULP_TERMINATE_BIG_PARAM_LEN                             ((uint8_t)  2)
#define HCI_ULP_BIG_CREATE_SYNC_PARAM_LEN                           ((uint8_t) 24) /* Variable */
#define HCI_ULP_BIG_TERMINATE_SYNC_PARAM_LEN                        ((uint8_t)  1)
#define HCI_ULP_ISO_TRANSMIT_TEST_PARAM_LEN                         ((uint8_t)  3)
#define HCI_ULP_ISO_RECEIVE_TEST_PARAM_LEN                          ((uint8_t)  3)
#define HCI_ULP_ISO_READ_TEST_COUNTERS_PARAM_LEN                    ((uint8_t)  2)
#define HCI_ULP_SETUP_ISO_DATA_PATH_PARAM_LEN                       ((uint8_t) 13) /* Variable */
#define HCI_ULP_REMOVE_ISO_DATA_PATH_PARAM_LEN                      ((uint8_t)  3)
#define HCI_ULP_SET_HOST_FEATURE_PARAM_LEN                          ((uint8_t)  2)
#define HCI_ULP_READ_ISO_LINK_QUALITY_PARAM_LEN                     ((uint8_t)  2)
#define HCI_ULP_SET_DEFAULT_SUBRATE_PARAM_LEN                       ((uint8_t) 10)
#define HCI_ULP_SUBRATE_REQUEST_PARAM_LEN                           ((uint8_t) 12)
#define HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL_PARAM_LEN        ((uint8_t)  3)
#define HCI_ULP_READ_REMOTE_TRANSMIT_POWER_LEVEL_PARAM_LEN          ((uint8_t)  3)
#define HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS_PARAM_LEN        ((uint8_t)  8)
#define HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE_PARAM_LEN            ((uint8_t)  3)
#define HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE_PARAM_LEN       ((uint8_t)  4)
...
#define HCI_EV_ENCRYPTION_CHANGE_V2_PARAM_LEN                    ((uint8_t)  5)
...
#define HCI_EV_ULP_CIS_ESTABLISHED_PARAM_LEN                     ((uint8_t) 17)
#define HCI_EV_ULP_CIS_REQUEST_PARAM_LEN                         ((uint8_t)  6)
#define HCI_EV_ULP_CREATE_BIG_COMPLETE_PARAM_LEN                 ((uint8_t) 21) /* Variable*/
#define HCI_EV_ULP_BIG_SYNC_ESTABLISHED_PARAM_LEN                ((uint8_t) 17) /* Variable*/
#define HCI_EV_ULP_REQUEST_PEER_SCA_COMPLETE_PARAM_LEN           ((uint8_t)  3)
#define HCI_EV_ULP_BIGINFO_ADV_REPORT_PARAM_LEN                  ((uint8_t) 21)
#define HCI_EV_ULP_SUBRATE_CHANGE_PARAM_LEN                      ((uint8_t) 12)
#define HCI_EV_ULP_PATH_LOSS_THRESHOLD_PARAM_LEN                 ((uint8_t)  5)
#define HCI_EV_ULP_TRANSMIT_POWER_REPORTING_PARAM_LEN            ((uint8_t)  9)
...
#define HCI_SET_MIN_ENCRYPTION_KEY_SIZE_ARG_LEN             ((uint8_t) 4)
...
#define HCI_CONFIGURE_DATA_PATH_ARG_LEN                ((uint8_t) 4)
...
#define HCI_ULP_SET_DATA_RELATED_ADDRESS_CHANGES_ARG_LEN          ((uint8_t)  4)
#define HCI_ULP_EXT_ADV_SET_RANDOM_ADDR_ARG_LEN                   ((uint8_t)  4)
#define HCI_ULP_EXT_ADV_SET_PARAMS_ARG_LEN                        ((uint8_t)  5)
#define HCI_ULP_EXT_ADV_SET_PARAMS_V2_ARG_LEN                     ((uint8_t)  5)
#define HCI_ULP_EXT_ADV_SET_DATA_ARG_LEN                          ((uint8_t)  4)
#define HCI_ULP_EXT_ADV_SET_SCAN_RESP_DATA_ARG_LEN                ((uint8_t)  4)
#define HCI_ULP_EXT_ADV_ENABLE_ARG_LEN                            ((uint8_t)  4)
#define HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN_ARG_LEN             ((uint8_t)  7)
#define HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS_ARG_LEN              ((uint8_t)  6)
#define HCI_ULP_EXT_ADV_REMOVE_ADV_SET_ARG_LEN                    ((uint8_t)  4)
#define HCI_ULP_EXT_ADV_CLEAR_ADV_SETS_ARG_LEN                    ((uint8_t)  4)
#define HCI_ULP_PERIODIC_ADV_SET_PARAMS_ARG_LEN                   ((uint8_t)  4)
#define HCI_ULP_PERIODIC_ADV_SET_DATA_ARG_LEN                     ((uint8_t)  4)
#define HCI_ULP_PERIODIC_ADV_ENABLE_ARG_LEN                       ((uint8_t)  4)
#define HCI_ULP_EXT_SCAN_SET_PARAMS_ARG_LEN                       ((uint8_t)  4)
#define HCI_ULP_EXT_SCAN_ENABLE_ARG_LEN                           ((uint8_t)  4)
#define HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_CANCEL_ARG_LEN        ((uint8_t)  4)
#define HCI_ULP_PERIODIC_SCAN_SYNC_TERMINATE_ARG_LEN              ((uint8_t)  4)
#define HCI_ULP_PERIODIC_SCAN_ADD_DEVICE_TO_PA_LIST_ARG_LEN       ((uint8_t)  4)
#define HCI_ULP_PERIODIC_SCAN_REMOVE_DEVICE_FROM_PA_LIST_ARG_LEN  ((uint8_t)  4)
#define HCI_ULP_PERIODIC_SCAN_CLEAR_PA_LIST_ARG_LEN               ((uint8_t)  4)
#define HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE_ARG_LEN           ((uint8_t)  5)
#define HCI_ULP_PERIODIC_SCAN_SYNC_REPORT_PERIODIC_ARG_LEN        ((uint8_t)  4)
#define HCI_ULP_PERIODIC_ADV_SYNC_TRANSFER_ARG_LEN                ((uint8_t)  4)
#define HCI_ULP_PERIODIC_ADV_SET_INFO_TRANSFER_ARG_LEN            ((uint8_t)  4)
#define HCI_ULP_PERIODIC_ADV_SET_SYNC_TRANSFER_PARAMS_ARG_LEN     ((uint8_t)  4)
#define HCI_ULP_SET_DEFAULT_PA_SYNC_TRANSFER_PARAMS_ARG_LEN       ((uint8_t)  4)
#define HCI_ULP_SET_PRIVACY_MODE_ARG_LEN                          ((uint8_t)  4)
#define HCI_ULP_SET_CIG_PARAMETERS_ARG_LEN                        ((uint8_t)  8) /* Variable */
#define HCI_ULP_SET_CIG_PARAMETERS_TEST_ARG_LEN                   ((uint8_t)  8) /* Variable */
#define HCI_ULP_REMOVE_CIG_ARG_LEN                                ((uint8_t)  5)
#define HCI_ULP_REJECT_CIS_REQUEST_ARG_LEN                        ((uint8_t)  6)
#define HCI_ULP_BIG_TERMINATE_SYNC_ARG_LEN                        ((uint8_t)  5)
#define HCI_ULP_ISO_TRANSMIT_TEST_ARG_LEN                         ((uint8_t)  6)
#define HCI_ULP_ISO_RECEIVE_TEST_ARG_LEN                          ((uint8_t)  6)
#define HCI_ULP_ISO_READ_TEST_COUNTERS_ARG_LEN                    ((uint8_t) 18)
#define HCI_ULP_SETUP_ISO_DATA_PATH_ARG_LEN                       ((uint8_t)  6)
#define HCI_ULP_REMOVE_ISO_DATA_PATH_ARG_LEN                      ((uint8_t)  6)
#define HCI_ULP_SET_HOST_FEATURE_ARG_LEN                          ((uint8_t)  4)
#define HCI_ULP_SET_DEFAULT_SUBRATE_ARG_LEN                       ((uint8_t)  4)
#define HCI_ULP_READ_ISO_LINK_QUALITY_ARG_LEN                     ((uint8_t)  34)
#define HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL_ARG_LEN        ((uint8_t)  9)
#define HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS_ARG_LEN        ((uint8_t)  6)
#define HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE_ARG_LEN            ((uint8_t)  6)
#define HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE_ARG_LEN       ((uint8_t)  6)
...
#define HCI_EV_MASK_ENCR_CHANGE_V2_HI               HCI_EV_MASK_HI2(HCI_EV_ENCRYPTION_CHANGE_V2)
#define HCI_EV_MASK_ENCR_CHANGE_V2_LO               HCI_EV_MASK_LO2(HCI_EV_ENCRYPTION_CHANGE_V2)
...
#define HCI_EV_MASK_DEFAULT_HI               ((hci_event_mask_t)0x00001FFFUL)
#define HCI_EV_MASK_DEFAULT_LO               ((hci_event_mask_t)0xFFFFFFFFUL)
...
#ifdef INSTALL_ULP
#define HCI_EV_MASK_VALID_HI                 ((hci_event_mask_t)0x3FFFFFFFUL)
#else
#define HCI_EV_MASK_VALID_HI                 ((hci_event_mask_t)0x1FFFFFFFUL)
#endif /* INSTALL_ULP */
#define HCI_EV_MASK_VALID_LO                 ((hci_event_mask_t)0xFFFFFFFFUL)
...
#define HCI_EV_MASK_ULP_VALID_LO                 ((hci_event_mask_t)0x000819FF)
#else
#define HCI_EV_MASK_ULP_VALID_LO                 ((hci_event_mask_t)0x000019FF)
#endif
...
#define HCI_EV_MASK_ULP_EXT_ADV_REPORT_HI                      HCI_EV_MASK_HI(HCI_EV_ULP_EXT_ADV_REPORT)
#define HCI_EV_MASK_ULP_EXT_ADV_REPORT_LO                      HCI_EV_MASK_LO(HCI_EV_ULP_EXT_ADV_REPORT)
#define HCI_EV_MASK_ULP_PERIODIC_ADV_SYNC_EST_HI               HCI_EV_MASK_HI(HCI_EV_ULP_PERIODIC_ADV_SYNC_EST)
#define HCI_EV_MASK_ULP_PERIODIC_ADV_SYNC_EST_LO               HCI_EV_MASK_LO(HCI_EV_ULP_PERIODIC_ADV_SYNC_EST)
#define HCI_EV_MASK_ULP_PERIODIC_ADV_REPORT_HI                 HCI_EV_MASK_HI(HCI_EV_ULP_PERIODIC_ADV_REPORT)
#define HCI_EV_MASK_ULP_PERIODIC_ADV_REPORT_LO                 HCI_EV_MASK_LO(HCI_EV_ULP_PERIODIC_ADV_REPORT)
#define HCI_EV_MASK_ULP_PERIODIC_ADV_SYNC_LOST_HI              HCI_EV_MASK_HI(HCI_EV_ULP_PERIODIC_ADV_SYNC_LOST)
#define HCI_EV_MASK_ULP_PERIODIC_ADV_SYNC_LOST_LO              HCI_EV_MASK_LO(HCI_EV_ULP_PERIODIC_ADV_SYNC_LOST)
#define HCI_EV_MASK_ULP_SCAN_TIMEOUT_HI                        HCI_EV_MASK_HI(HCI_EV_ULP_SCAN_TIMEOUT)
#define HCI_EV_MASK_ULP_SCAN_TIMEOUT_LO                        HCI_EV_MASK_LO(HCI_EV_ULP_SCAN_TIMEOUT)
#define HCI_EV_MASK_ULP_ADV_SET_TERMINATED_HI                  HCI_EV_MASK_HI(HCI_EV_ULP_ADV_SET_TERMINATED)
#define HCI_EV_MASK_ULP_ADV_SET_TERMINATED_LO                  HCI_EV_MASK_LO(HCI_EV_ULP_ADV_SET_TERMINATED)
#define HCI_EV_MASK_ULP_PA_SYNC_TRANSFER_RECEIVED_HI           HCI_EV_MASK_HI(HCI_EV_ULP_PA_SYNC_TRANSFER_RECEIVED)
#define HCI_EV_MASK_ULP_PA_SYNC_TRANSFER_RECEIVED_LO           HCI_EV_MASK_LO(HCI_EV_ULP_PA_SYNC_TRANSFER_RECEIVED)
#define HCI_EV_MASK_ULP_CIS_ESTABLISHED_HI                     HCI_EV_MASK_HI(HCI_EV_ULP_CIS_ESTABLISHED)
#define HCI_EV_MASK_ULP_CIS_ESTABLISHED_LO                     HCI_EV_MASK_LO(HCI_EV_ULP_CIS_ESTABLISHED)
#define HCI_EV_MASK_ULP_CIS_REQUEST_HI                         HCI_EV_MASK_HI(HCI_EV_ULP_CIS_REQUEST)
#define HCI_EV_MASK_ULP_CIS_REQUEST_LO                         HCI_EV_MASK_LO(HCI_EV_ULP_CIS_REQUEST)
#define HCI_EV_MASK_ULP_CREATE_BIG_COMPLETE_HI                 HCI_EV_MASK_HI(HCI_EV_ULP_CREATE_BIG_COMPLETE)
#define HCI_EV_MASK_ULP_CREATE_BIG_COMPLETE_LO                 HCI_EV_MASK_LO(HCI_EV_ULP_CREATE_BIG_COMPLETE)
#define HCI_EV_MASK_ULP_TERMINATE_BIG_COMPLETE_HI              HCI_EV_MASK_HI(HCI_EV_ULP_TERMINATE_BIG_COMPLETE)
#define HCI_EV_MASK_ULP_TERMINATE_BIG_COMPLETE_LO              HCI_EV_MASK_LO(HCI_EV_ULP_TERMINATE_BIG_COMPLETE)
#define HCI_EV_MASK_ULP_BIG_SYNC_ESTABLISHED_HI                HCI_EV_MASK_HI(HCI_EV_ULP_BIG_SYNC_ESTABLISHED)
#define HCI_EV_MASK_ULP_BIG_SYNC_ESTABLISHED_LO                HCI_EV_MASK_LO(HCI_EV_ULP_BIG_SYNC_ESTABLISHED)
#define HCI_EV_MASK_ULP_BIG_SYNC_LOST_HI                       HCI_EV_MASK_HI(HCI_EV_ULP_BIG_SYNC_LOST)
#define HCI_EV_MASK_ULP_BIG_SYNC_LOST_LO                       HCI_EV_MASK_LO(HCI_EV_ULP_BIG_SYNC_LOST)
#define HCI_EV_MASK_ULP_REQUEST_PEER_SCA_COMPLETE_HI           HCI_EV_MASK_HI(HCI_EV_ULP_REQUEST_PEER_SCA_COMPLETE)
#define HCI_EV_MASK_ULP_REQUEST_PEER_SCA_COMPLETE_LO           HCI_EV_MASK_LO(HCI_EV_ULP_REQUEST_PEER_SCA_COMPLETE)
#define HCI_EV_MASK_ULP_BIGINFO_ADV_REPORT_HI                  HCI_EV_MASK_HI(HCI_EV_ULP_BIGINFO_ADV_REPORT)
#define HCI_EV_MASK_ULP_BIGINFO_ADV_REPORT_LO                  HCI_EV_MASK_LO(HCI_EV_ULP_BIGINFO_ADV_REPORT)
#define HCI_EV_MASK_ULP_SUBRATE_CHANGE_HI                      HCI_EV_MASK_HI(HCI_EV_ULP_SUBRATE_CHANGE)
#define HCI_EV_MASK_ULP_SUBRATE_CHANGE_LO                      HCI_EV_MASK_LO(HCI_EV_ULP_SUBRATE_CHANGE)
#define HCI_EV_MASK_ULP_PATH_LOSS_THRESHOLD_HI                 HCI_EV_MASK_HI(HCI_EV_ULP_PATH_LOSS_THRESHOLD)
#define HCI_EV_MASK_ULP_PATH_LOSS_THRESHOLD_LO                 HCI_EV_MASK_LO(HCI_EV_ULP_PATH_LOSS_THRESHOLD)
#define HCI_EV_MASK_ULP_TRANSMIT_POWER_REPORTING_HI            HCI_EV_MASK_HI(HCI_EV_ULP_TRANSMIT_POWER_REPORTING)
#define HCI_EV_MASK_ULP_TRANSMIT_POWER_REPORTING_LO            HCI_EV_MASK_LO(HCI_EV_ULP_TRANSMIT_POWER_REPORTING)
...
#define HCI_VER_5_2               ((hci_version_t)0x0b)
#define HCI_VER_5_3               ((hci_version_t)0x0c)
#define HCI_VER_5_4               ((hci_version_t)0x0d)

#define HCI_VER_MAX    HCI_VER_5_4 /* Latest supported HCI version */
...
#define ULP_FEATURE_LE_CODED_PHY                            11
#define ULP_FEATURE_EXTENDED_ADVERTISING                    12
#define ULP_FEATURE_PERIODIC_ADVERTISING                    13
#define ULP_FEATURE_CHANNEL_SELECTION_ALGORITHM_2           14
#define ULP_FEATURE_PAST_SENDER                             24
#define ULP_FEATURE_PAST_RECIPIENT                          25
#define ULP_FEATURE_POWER_CNTROL_REQUEST                    33
#define ULP_FEATURE_POWER_CNTROL_INDICATION                 34
#define ULP_FEATURE_PATH_LOSS_MONITORING                    35
#define ULP_FEATURE_PERIODIC_ADVERTISING_ADI                36
#define ULP_FEATURE_ADVERTISING_CODING_SELECTION            40
...
/*-----------------------------------------------------------------------------*
 *  ULP
 *  EA adv_event_properties
 *
 *------------------------------------------------------------------------------*/
/* Bit definitions */
#define HCI_ULP_EXT_ADV_NON_CONN_AND_NON_SCAN_ADVERTISING ((uint16_t)0x0000)
#define HCI_ULP_EXT_ADV_CONNECTABLE_ADVERTISING           ((uint16_t)0x0001)
#define HCI_ULP_EXT_ADV_SCANNABLE_ADVERTISING             ((uint16_t)0x0002)
#define HCI_ULP_EXT_ADV_DIRECTED_ADVERTISING              ((uint16_t)0x0004)
#define HCI_ULP_EXT_ADV_HIGH_DUTY_DIRECTED_ADVERTISING    ((uint16_t)0x0008)
#define HCI_ULP_EXT_ADV_LEGACY_ADVERTISING                ((uint16_t)0x0010)
#define HCI_ULP_EXT_ADV_OMIT_ADV_ADDRESS                  ((uint16_t)0x0020)
#define HCI_ULP_EXT_ADV_INCLUDE_TX_POWER                  ((uint16_t)0x0040)

/* legacy primary advertising */
#define HCI_ULP_EXT_ADV_LEGACY_CONNECTABLE_UNDIRECTED           ((uint16_t)(0x0003 | \
                                                    HCI_ULP_EXT_ADV_LEGACY_ADVERTISING))
#define HCI_ULP_EXT_ADV_LEGACY_CONNECTABLE_DIRECTED_HIGH_DUTY   ((uint16_t)(0x000d | \
                                                    HCI_ULP_EXT_ADV_LEGACY_ADVERTISING))
#define HCI_ULP_EXT_ADV_LEGACY_DISCOVERABLE                     ((uint16_t)(0x0002 | \
                                                    HCI_ULP_EXT_ADV_LEGACY_ADVERTISING))
#define HCI_ULP_EXT_ADV_LEGACY_NON_CONNECTABLE                  ((uint16_t)(0x0000 | \
                                                    HCI_ULP_EXT_ADV_LEGACY_ADVERTISING))
#define HCI_ULP_EXT_ADV_LEGACY_CONNECTABLE_DIRECTED_LOW_DUTY    ((uint16_t)(0x0005 | \
                                                    HCI_ULP_EXT_ADV_LEGACY_ADVERTISING))

#define HCI_ULP_EXT_ADV_LEGACY_MASK ((uint16_t) 0x001F)

/*-----------------------------------------------------------------------------*
 *  ULP
 *  EA Primary and Secondary advertising phys
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EXT_ADV_1M_PHY           ((uint8_t)0x01)
#define HCI_ULP_EXT_ADV_2M_PHY           ((uint8_t)0x02) /* Invalid for primary */
#define HCI_ULP_EXT_ADV_CODED_PHY        ((uint8_t)0x03)

/*-----------------------------------------------------------------------------*
 *  ULP
 *  ES Scanning and Initiating phy bits
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EXT_SCAN_1M_PHY_BIT          ((uint8_t)0x01)
#define HCI_ULP_EXT_SCAN_2M_PHY_BIT          ((uint8_t)0x02)
#define HCI_ULP_EXT_SCAN_CODED_PHY_BIT       ((uint8_t)0x04)

/*-----------------------------------------------------------------------------*
 *  ULP
 *  EA Advertising data and scan response data operation
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EXT_ADV_DATA_INTERMEDIATE_FRAG   ((uint8_t)0x00)
#define HCI_ULP_EXT_ADV_DATA_FIRST_FRAG          ((uint8_t)0x01)
#define HCI_ULP_EXT_ADV_DATA_LAST_FRAG           ((uint8_t)0x02)
#define HCI_ULP_EXT_ADV_DATA_COMPLETE            ((uint8_t)0x03)
#define HCI_ULP_EXT_ADV_DATA_UNCHANGED           ((uint8_t)0x04)

/*-----------------------------------------------------------------------------*
 *  ULP
 *  EA Advertising TX Power
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_EXT_ADV_TX_POWER_NO_PREFERENCE   ((uint8_t)0x7F)
...
/* Additional extended scanning address types */
#define HCI_ULP_PEER_ADDRESS_ANONYMOUS             ((uint8_t)0xFF)
#define HCI_ULP_PEER_ADDRESS_RPA_UNRESOLVED        ((uint8_t)0xFE)
...
/* Extended Scanning Only */
#define HCI_ULP_FILTER_DUPLICATES_PERIOD    ((uint8_t)0x02)
 ...
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_PAST_MODE_IGNORE                            ((uint8_t)0x00)
#define HCI_ULP_PAST_MODE_SYNC_NO_REPORTS                   ((uint8_t)0x01)
#define HCI_ULP_PAST_MODE_SYNC_ENABLE_REPORTS_NO_FILTER     ((uint8_t)0x02)
#define HCI_ULP_PAST_MODE_SYNC_ENABLE_REPORTS_FILTER_DUPS   ((uint8_t)0x03)

/*-----------------------------------------------------------------------------*
 *  ULP
 *  Periodic Advertising Sync Transfer CTE_Type
 *
 *------------------------------------------------------------------------------*/
#define HCI_ULP_PAST_CTE_NO_SYNC_IF_AOA                     ((uint8_t)0x00)
#define HCI_ULP_PAST_CTE_NO_SYNC_IF_AOD_1US_SLOTS           ((uint8_t)0x01)
#define HCI_ULP_PAST_CTE_NO_SYNC_IF_AOD_2US_SLOTS           ((uint8_t)0x02)
#define HCI_ULP_PAST_CTE_NO_SYNC_WITHOUT_CTE                ((uint8_t)0x03)
 ...
 *------------------------------------------------------------------------------*/
/* Bit definitions */
#define HCI_ULP_EV_NON_CONN_AND_NON_SCAN_ADVERTISING ((uint16_t)0x0000)
#define HCI_ULP_EV_CONNECTABLE_ADVERTISING           ((uint16_t)0x0001)
#define HCI_ULP_EV_SCANNABLE_ADVERTISING             ((uint16_t)0x0002)
#define HCI_ULP_EV_DIRECTED_ADVERTISING              ((uint16_t)0x0004)
#define HCI_ULP_EV_SCAN_RESPONSE                     ((uint16_t)0x0008)
#define HCI_ULP_EV_LEGACY_ADVERTISING                ((uint16_t)0x0010)

/* legacy primary advertising */
#define HCI_ULP_EV_ADV_IND           ((uint16_t)(HCI_ULP_EV_LEGACY_ADVERTISING | \
                                                 HCI_ULP_EV_CONNECTABLE_ADVERTISING | \
                                                 HCI_ULP_EV_SCANNABLE_ADVERTISING))
#define HCI_ULP_EV_ADV_DIRECT_IND    ((uint16_t)(HCI_ULP_EV_LEGACY_ADVERTISING | \
                                                 HCI_ULP_EV_CONNECTABLE_ADVERTISING | \
                                                 HCI_ULP_EV_DIRECTED_ADVERTISING))
#define HCI_ULP_EV_ADV_SCAN_IND      ((uint16_t)(HCI_ULP_EV_LEGACY_ADVERTISING | \
                                                 HCI_ULP_EV_SCANNABLE_ADVERTISING))
#define HCI_ULP_EV_ADV_NONCONN_IND   ((uint16_t)(HCI_ULP_EV_LEGACY_ADVERTISING))
#define HCI_ULP_EV_SCAN_RSP          ((uint16_t)(HCI_ULP_EV_LEGACY_ADVERTISING | \
                                                 HCI_ULP_EV_SCANNABLE_ADVERTISING | \
                                                 HCI_ULP_EV_SCAN_RESPONSE))

#define HCI_ULP_EV_ADV_PDU_MASK      ((uint16_t)0x1F)

/* data status */
#define HCI_ULP_EV_EXT_ADV_STATUS_COMPLETE        ((uint16_t)0x00)
#define HCI_ULP_EV_EXT_ADV_STATUS_MORE_DATA       ((uint16_t)0x20)
#define HCI_ULP_EV_EXT_ADV_STATUS_TRUNCATED       ((uint16_t)0x40)

#define HCI_ULP_EV_EXT_ADV_STATUS_MASK            ((uint16_t)0x60)

/*-----------------------------------------------------------------------------*
 *  ULP
 *  Periodic Advertising Report Event_Type
 *
 *------------------------------------------------------------------------------*/
/* data status */
#define HCI_ULP_EV_PERIODIC_ADV_STATUS_COMPLETE        ((uint8_t)0x00)
#define HCI_ULP_EV_PERIODIC_ADV_STATUS_MORE_DATA       ((uint8_t)0x01)
#define HCI_ULP_EV_PERIODIC_ADV_STATUS_TRUNCATED       ((uint8_t)0x02)
...
#define HCI_ULP_QHS_PHY                           ((uint8_t)0x80)
#define HCI_ULP_PHY_1LE_2LE     (HCI_ULP_2LE_PHY_1MBPS | HCI_ULP_2LE_PHY_2MBPS)
#define HCI_ULP_PHY_ALL         (HCI_ULP_PHY_1LE_2LE | HCI_ULP_PHY_LE_CODED | HCI_ULP_QHS_PHY)
...
/* Codec config data length 242
 * 242 = 255(HCI CMD length) - 13 bytes  (other parameters in command) */
#define HCI_CODEC_CONFIG_DATA_LENGTH            242
#define HCI_CODEC_CONFIG_DATA_PER_PTR           HCI_VAR_ARG_POOL_SIZE
#define HCI_CODEC_CONFIG_DATA_PTRS              ((HCI_CODEC_CONFIG_DATA_LENGTH + HCI_CODEC_CONFIG_DATA_PER_PTR - 1)  / HCI_CODEC_CONFIG_DATA_PER_PTR)
...
#define HCI_ULP_MAX_ENABLE_ADV_SETS                 8
#define HCI_ULP_ENABLE_ADV_SETS_PER_PTR             (HCI_VAR_ARG_POOL_SIZE / sizeof(EA_ENABLE_ADV_SET_T))
#define HCI_ULP_ENABLE_ADV_SETS_PTRS                (((HCI_ULP_MAX_ENABLE_ADV_SETS - 1) / HCI_ULP_ENABLE_ADV_SETS_PER_PTR) + 1)

#define HCI_ULP_MAX_INITIATING_PHYS                 3
#define HCI_ULP_INITIATING_PHYS_PER_PTR             (HCI_VAR_ARG_POOL_SIZE / sizeof(ES_INITIATING_PHY_T))
#define HCI_ULP_INITIATING_PHYS_PTRS                (((HCI_ULP_MAX_INITIATING_PHYS - 1) / HCI_ULP_INITIATING_PHYS_PER_PTR) + 1)

#define HCI_ULP_MAX_SCANNING_PHYS                   2
#define HCI_ULP_SCANNING_PHYS_PER_PTR               (HCI_VAR_ARG_POOL_SIZE / sizeof(ES_SCANNING_PHY_T))
#define HCI_ULP_SCANNING_PHYS_PTRS                  (((HCI_ULP_MAX_SCANNING_PHYS - 1) / HCI_ULP_SCANNING_PHYS_PER_PTR) + 1)
...
#define HCI_CONFIGURE_DATA_PATH_LENGTH              255
#define HCI_CONFIGURE_DATA_PATH_PER_PTR             HCI_VAR_ARG_POOL_SIZE
#define HCI_CONFIGURE_DATA_PATH_PTRS                ((HCI_CONFIGURE_DATA_PATH_LENGTH + HCI_CONFIGURE_DATA_PATH_PER_PTR - 1)  / HCI_CONFIGURE_DATA_PATH_PER_PTR)
...
typedef struct
{
    uint8_t             scan_type;        /* Refer to LE_Scan_Type */
    uint16_t            scan_interval;    /* 4 to 0xFFFF (2.5ms to 40.95 seconds) */
    uint16_t            scan_window;      /* 4 to 0xFFFF (2.5ms to 40.95 seconds) */
} ES_SCANNING_PHY_T;
...
} HCI_SET_MIN_ENCRYPTION_KEY_SIZE_T;
...
typedef struct
{
    ...
    uint8_t                  *vendor_specific_config[HCI_CONFIGURE_DATA_PATH_PTRS];
} HCI_CONFIGURE_DATA_PATH_T;
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Data Related Address Changes command
 *
 *     Note) If legacy advertising commands are being used, the Controller
 *           ignores the Advertising_Handle parameter.
 *----------------------------------------------------------------------------*/

/* Bit values for field change_reasons */
#define HCI_ULP_ADDRESS_CHANGE_FOR_ADV_DATA 1
#define HCI_ULP_ADDRESS_CHANGE_FOR_SCAN_RESP_DATA 2
...
} HCI_ULP_SET_DATA_RELATED_ADDRESS_CHANGES_T;
...
} HCI_ULP_EXT_ADV_SET_RANDOM_ADDR_T;
...
} HCI_ULP_EXT_ADV_SET_PARAMS_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Extended Advertising Parameters V2 Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_ULP_EXT_ADV_SET_PARAMS_V2_T;

typedef struct
{
    int8_t                   selected_tx_power;
} HCI_ULP_EXT_ADV_SET_PARAMS_RET_T;
...
} HCI_ULP_EXT_ADV_SET_SCAN_RESP_DATA_T;
...
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN_T;

typedef struct
{
    uint16_t                  max_adv_data_len;
} HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN_RET_T;
...
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS_T;

typedef struct
{
    uint8_t                   num_of_adv_sets;
} HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS_RET_T;
...
typedef struct
{
    HCI_COMMAND_COMMON_T      common;
    uint8_t                   adv_handle;
} HCI_ULP_EXT_ADV_REMOVE_ADV_SET_T;
...
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_EXT_ADV_CLEAR_ADV_SETS_T;
...
} HCI_ULP_PERIODIC_ADV_SET_PARAMS_T;
...
} HCI_ULP_PERIODIC_ADV_SET_DATA_T;
 ...
 *
 *----------------------------------------------------------------------------*/
/* Bit field defines for enable field */
#define HCI_ULP_PERIODIC_ADV_EN     ((uint8_t) 0x01)  /* Enable periodic advertising */
#define HCI_ULP_PERIODIC_ADV_ADI    ((uint8_t) 0x02)  /* ADI in AUX_SYNC_IND PDUs    */
...
typedef struct
{
    ...
    ES_INITIATING_PHY_T      *init_phys[HCI_ULP_INITIATING_PHYS_PTRS];
} HCI_ULP_EXT_SCAN_CREATE_CONNECTION_T;
 ...
 *
 *----------------------------------------------------------------------------*/
/* Bit field defines for options field */
#define HCI_ULP_OPTION_PERIODIC_ADVERTISER_LIST             ((uint8_t) 0x01)
#define HCI_ULP_OPTION_PERIODIC_REPORTS_DISABLE             ((uint8_t) 0x02)
#define HCI_ULP_OPTION_PERIODIC_REPORTS_DUPLICATE_FILTERING ((uint8_t) 0x04)
...
} HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_T;
...
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_CANCEL_T;
...
} HCI_ULP_PERIODIC_SCAN_SYNC_TERMINATE_T;
...
typedef struct
{
    ...
    BD_ADDR_T                 adv_addr;
    uint8_t                   adv_sid;
} HCI_ULP_PERIODIC_SCAN_ADD_DEVICE_TO_PA_LIST_T;
...
typedef struct
{
    ...
    BD_ADDR_T                 adv_addr;
    uint8_t                   adv_sid;
} HCI_ULP_PERIODIC_SCAN_REMOVE_DEVICE_FROM_PA_LIST_T;
...
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_PERIODIC_SCAN_CLEAR_PA_LIST_T;
...
{
    HCI_COMMAND_COMMON_T      common;
} HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE_T;

typedef struct
{
    uint8_t                   pa_list_size;
} HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE_RET_T;
 ...
 *----------------------------------------------------------------------------*/
/* Bit field defines for enable field */
#define HCI_ULP_ENABLE_PERIODIC_REPORTS       ((uint8_t) 0x01)
#define HCI_ULP_ENABLE_DUPLICATE_FILTERING    ((uint8_t) 0x02)
...
typedef struct
{
    ...
    uint16_t                  sync_handle;
    uint8_t                   enable;
} HCI_ULP_PERIODIC_SCAN_SYNC_REPORT_PERIODIC_T;
...
typedef struct
{
    ...
    uint16_t                  sync_handle;
} HCI_ULP_PERIODIC_ADV_SYNC_TRANSFER_T;
...
typedef struct
{
    ...
    uint16_t                  service_data;
    uint8_t                   adv_handle;
} HCI_ULP_PERIODIC_ADV_SET_INFO_TRANSFER_T;
...
typedef struct
{
    ...
    uint16_t                  sync_timeout;
    uint8_t                   cte_type;
} HCI_ULP_PERIODIC_ADV_SET_SYNC_TRANSFER_PARAMS_T;
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Enhanced Read Transmit Power Level command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    hci_connection_handle_t   connection_handle;
    uint8_t                   phy;
} HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL_T;
...
} HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL_RET_T;
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Read Remote Transmit Power Level command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    hci_connection_handle_t   connection_handle;
    uint8_t                   phy;
} HCI_ULP_READ_REMOTE_TRANSMIT_POWER_LEVEL_T;
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Path Loss reporting parameters command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS_T;

typedef struct
{
    hci_connection_handle_t   connection_handle;
} HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS_RET_T;
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Path Loss reporting enable command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    hci_connection_handle_t   connection_handle;
    uint8_t                   enable;
} HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE_T;

typedef struct
{
    hci_connection_handle_t   connection_handle;
} HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE_RET_T;
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set transmit power reporting enable command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE_T;

typedef struct
{
    hci_connection_handle_t   connection_handle;
} HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE_RET_T;
/*----------------------------------------------------------------------------*
 * PURPOSE
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Connected Isochronous Group Parameters 
 *
 *----------------------------------------------------------------------------*/
#define  HCI_CIS_MAX             ((uint8_t)0x08)
...
typedef struct
{
    ...
    uint8_t                cis_count;
    HCI_CIS_PARAM_T       *cis_param[HCI_CIS_MAX];
}HCI_ULP_SET_CIG_PARAMETERS_T;

typedef struct
{
    uint8_t                    cig_id;
    uint8_t                    cis_count;
    hci_connection_handle_t    connection_handle[HCI_CIS_MAX];
}HCI_ULP_SET_CIG_PARAMETERS_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Connected Isochronous Group Parameters Test Command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
typedef struct
{
    ...
    uint8_t                 framing;
    uint8_t                 cis_count;
    HCI_CIS_PARAM_TEST_T   *cis_param[HCI_CIS_MAX];
}HCI_ULP_SET_CIG_PARAMETERS_TEST_T;
...
typedef struct
{
    ...
    uint8_t                    cis_count;
    hci_connection_handle_t    connection_handle[HCI_CIS_MAX];
}HCI_ULP_SET_CIG_PARAMETERS_TEST_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Remove Connected Isochronous Group
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    uint8_t                  cig_id;
}HCI_ULP_REMOVE_CIG_T;

typedef struct
{
    uint8_t                    cig_id;
} HCI_ULP_REMOVE_CIG_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Create Connected Isochronous Stream
 *
 *----------------------------------------------------------------------------*/
...
}HCI_CIS_CONNECTION_T;
 
 typedef struct
{
    HCI_COMMAND_COMMON_T    common;
    uint8_t                 cis_count;
    HCI_CIS_CONNECTION_T   *cis_connection[HCI_CIS_MAX];
}HCI_ULP_CREATE_CIS_T;


/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Accept Connected Isochronous Stream
 *
 *----------------------------------------------------------------------------*/
 typedef struct
{
    HCI_COMMAND_COMMON_T       common;
    hci_connection_handle_t    cis_handle;
}HCI_ULP_ACCEPT_CIS_REQUEST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Reject Connected Isochronous Stream
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    hci_connection_handle_t    cis_handle;
    uint8_t                    reason;
}HCI_ULP_REJECT_CIS_REQUEST_T;

typedef struct
{
    hci_connection_handle_t    cis_handle;
}HCI_ULP_REJECT_CIS_REQUEST_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Create BIG command
 *
 *----------------------------------------------------------------------------*/
#define HCI_ULP_MAX_BIS_HANDLES                     31
...
}HCI_ULP_CREATE_BIG_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Create BIG Test command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                  encryption;
    uint8_t                  broadcast_code[16];
}HCI_ULP_CREATE_BIG_TEST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Terminate BIG command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                  big_handle;
    uint8_t                  reason;
}HCI_ULP_TERMINATE_BIG_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP BIG Create sync command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                 sync_handle;
    uint8_t                  encryption;
    uint8_t                  broadcast_code[HCI_ULP_BROADCAST_CODE_SIZE];
    uint8_t                  mse;
    uint16_t                 big_sync_timeout;
    uint8_t                  num_bis;
    uint8_t                  *bis;
}HCI_ULP_BIG_CREATE_SYNC_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP BIG Terminate sync command
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    uint8_t                  big_handle;
}HCI_ULP_BIG_TERMINATE_SYNC_T;

typedef struct
{
    uint8_t                  big_handle;
}HCI_ULP_BIG_TERMINATE_SYNC_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Request Peer Sleep Clock Accuracy
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
     ...
     hci_connection_handle_t  connection_handle;
     ADDED_TYPED_BD_ADDRESS
}HCI_ULP_REQUEST_PEER_SCA_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP setup ISO data path is used to set the vendor specific
 *     transport interface for the ISO data.
 *
 *----------------------------------------------------------------------------*/
#define HCI_CODEC_ID_OCTETS_SIZE  5
...
typedef struct
{
   ...
   uint8_t                    data_path_direction;
   uint8_t                    data_path_id;
   uint8_t                    codec_id[HCI_CODEC_ID_OCTETS_SIZE];
   uint24_t                   controller_delay;
   uint8_t                    codec_config_length;
   uint8_t                   *codec_config_data[HCI_CODEC_CONFIG_DATA_PTRS];
}HCI_ULP_SETUP_ISO_DATA_PATH_T;

typedef struct
{
    hci_connection_handle_t    handle;
}HCI_ULP_SETUP_ISO_DATA_PATH_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Remove ISO data path will remove the input and output data path
 *     associated with the CIS or BIS handle.
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
   ...
   hci_connection_handle_t    handle;    /* CIS or BIS handle */
   uint8_t                    data_path_direction;
}HCI_ULP_REMOVE_ISO_DATA_PATH_T;

typedef struct
{
    hci_connection_handle_t    handle;
}HCI_ULP_REMOVE_ISO_DATA_PATH_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     To Send and recieve the ISO data with in controller,
 *     These commands are not for Applications.
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
...
}HCI_ULP_ISO_TRANSMIT_TEST_T;

typedef struct
{
    hci_connection_handle_t  connection_handle;
} HCI_ULP_ISO_TRANSMIT_TEST_RET_T;
...
typedef struct
{
    ...
    hci_connection_handle_t  connection_handle;
    uint8_t                  payload_type;
}HCI_ULP_ISO_RECEIVE_TEST_T;

typedef struct
{
    hci_connection_handle_t  connection_handle;
} HCI_ULP_ISO_RECEIVE_TEST_RET_T;

typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    hci_connection_handle_t  connection_handle;
}HCI_ULP_ISO_READ_TEST_COUNTERS_T;
...
} HCI_ULP_ISO_READ_TEST_COUNTERS_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     To set or clear the host support feature command in controller,
 *     These commands are not for Applications.
 *----------------------------------------------------------------------------*/
#define HCI_ISOC_CHANNEL_HOST_SUPPORT_FEATURE                   ((uint8_t) 0x20)
#define HCI_LE_CONNECTION_SUBRATING_HOST_SUPPORT_FEATURE        ((uint8_t) 0x26)
#define HCI_LE_ADV_CODING_SELECTION_HOST_SUPPORT_FEATURE        ((uint8_t) 0x29)
...
typedef struct
{
    ...
    uint8_t  bit_number;
    uint8_t  bit_value;
}HCI_ULP_SET_HOST_FEATURE_T;

typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    hci_connection_handle_t  connection_handle;
}HCI_ULP_READ_ISO_LINK_QUALITY_T;
...
}HCI_ULP_READ_ISO_LINK_QUALITY_RET_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Set Default Subrate
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
    ...
    uint16_t                 supervision_timeout;
}HCI_ULP_SET_DEFAULT_SUBRATE_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *     HCI ULP Subrate Request
 *----------------------------------------------------------------------------*/
typedef struct
{
    HCI_COMMAND_COMMON_T     common;
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *      Connected Isochronous Stream established
 *      HCI ULP CIS Established Event. (0x3E, subevent code: 0x19)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                  max_pdu_s_to_m;
    uint16_t                  iso_interval;
}HCI_EV_ULP_CIS_ESTABLISHED_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      Connection Isochronous Stream establishment request
 *      HCI ULP CIS Established Event. (0x3E, subevent code: 0x1A)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                   cig_id;
    uint8_t                   cis_id;
}HCI_EV_ULP_CIS_REQUEST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      Create BIG request is completed
 *      Create BIG complete event. (0x3E, subevent code: 0x1B)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint16_t                 iso_interval;
    uint8_t                  num_bis;
    hci_connection_handle_t  *bis_handles;
}HCI_EV_ULP_CREATE_BIG_COMPLETE_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      Terminate BIG request is completed
 *      Terminate BIG complete event. (0x3E, subevent code: 0x1C)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                  big_handle;
    uint8_t                  reason;
}HCI_EV_ULP_TERMINATE_BIG_COMPLETE_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      BIG sync create request is completed
 *      Big sync established event. (0x3E, subevent code: 0x1D)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                  num_bis;
    hci_connection_handle_t  *bis_handles;
}HCI_EV_ULP_BIG_SYNC_ESTABLISHED_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      BIG sync is lost with the peer device
 *      Big sync lost event. (0x3E, subevent code: 0x1E)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                  big_handle;
    uint8_t                  reason;
}HCI_EV_ULP_BIG_SYNC_LOST_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      
 *      HCI ULP Request Peer SCA Complete Event. (0x3E, subevent code: 0x1F)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    hci_connection_handle_t   handle;
    uint8_t                   sca;
}HCI_EV_ULP_REQUEST_PEER_SCA_COMPLETE_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      Advertising report event with BIGInfo
 *      BIGInfo advertising report event. (0x3E, subevent code: 0x22)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    uint8_t                  framing;
    uint8_t                  encryption;
}HCI_EV_ULP_BIGINFO_ADV_REPORT_T;
 
 /*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP PATH LOSS THRESHOLD Event. (0x3E, subevent code: 0x20)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
} HCI_EV_ULP_PATH_LOSS_THRESHOLD_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *
 *      HCI ULP TRANSMIT POWER REPORTING Event. (0x3E, subevent code: 0x21)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
    ...
    int8_t                  delta;
} HCI_EV_ULP_TRANSMIT_POWER_REPORTING_T;

/*----------------------------------------------------------------------------*
 * PURPOSE
 *      
 *      HCI ULP Subrate Change Event. (0x3E, subevent code: 0x23)
 *
 *----------------------------------------------------------------------------*/
typedef struct
{
...
typedef union
{
    ...
    HCI_ULP_EXT_ADV_SET_PARAMS_RET_T                        ulp_set_ea_params_args;
    HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN_RET_T             ulp_ea_read_max_adv_data_len_args;
    HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS_RET_T              ulp_ea_read_num_of_adv_sets_args;
    HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE_RET_T           ulp_ps_read_pa_list_size_args;
    HCI_ULP_SET_CIG_PARAMETERS_RET_T                        hci_ulp_set_cig_parameters_args;
    HCI_ULP_SET_CIG_PARAMETERS_TEST_RET_T                   hci_ulp_set_cig_parameters_test_args;
    HCI_ULP_REMOVE_CIG_RET_T                                hci_ulp_remove_cig_args;
    HCI_ULP_REJECT_CIS_REQUEST_RET_T                        hci_ulp_reject_cis_request_args;
    HCI_ULP_BIG_TERMINATE_SYNC_RET_T                        hci_ulp_big_terminate_sync_args;
    HCI_ULP_ISO_TRANSMIT_TEST_RET_T                         hci_ulp_iso_transmit_test_args;
    HCI_ULP_ISO_RECEIVE_TEST_RET_T                          hci_ulp_iso_receive_test_args;
    HCI_ULP_ISO_READ_TEST_COUNTERS_RET_T                    hci_ulp_iso_read_test_counters_args;
    HCI_ULP_SETUP_ISO_DATA_PATH_RET_T                       hci_ulp_setup_iso_data_path_args;
    HCI_ULP_REMOVE_ISO_DATA_PATH_RET_T                      hci_ulp_remove_iso_data_path_args;
    HCI_ULP_READ_ISO_LINK_QUALITY_RET_T                     hci_ulp_read_iso_link_quality_args;
    HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL_RET_T        hci_ulp_enhanced_read_transmit_power_level_args;
    HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS_RET_T        hci_ulp_set_path_loss_reporting_parameters_args;
    HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE_RET_T            hci_ulp_set_path_loss_reporting_enable_args;
    HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE_RET_T       hci_ulp_set_transmit_power_reporting_enable_args;
...
typedef union hci_uprim_tag
{
    ...
    HCI_CONFIGURE_DATA_PATH_T               hci_configure_data_path;
    ...
    HCI_ULP_SET_DATA_RELATED_ADDRESS_CHANGES_T          hci_ulp_set_data_related_address_changes;
    HCI_ULP_EXT_ADV_SET_RANDOM_ADDR_T                   hci_ulp_set_ea_random_addr;
    HCI_ULP_EXT_ADV_SET_PARAMS_T                        hci_ulp_set_ea_params;
    HCI_ULP_EXT_ADV_SET_PARAMS_V2_T                     hci_ulp_set_ea_params_v2;
    HCI_ULP_EXT_ADV_SET_DATA_T                          hci_ulp_set_ea_data;
    HCI_ULP_EXT_ADV_SET_SCAN_RESP_DATA_T                hci_ulp_set_ea_scan_resp_data;
    HCI_ULP_EXT_ADV_ENABLE_T                            hci_ulp_ea_enable;
    HCI_ULP_EXT_ADV_READ_MAX_ADV_DATA_LEN_T             hci_ulp_ea_read_max_adv_data_len;
    HCI_ULP_EXT_ADV_READ_NUM_OF_ADV_SETS_T              hci_ulp_ea_read_num_of_adv_sets;
    HCI_ULP_EXT_ADV_REMOVE_ADV_SET_T                    hci_ulp_ea_remove_adv_set;
    HCI_ULP_EXT_ADV_CLEAR_ADV_SETS_T                    hci_ulp_ea_clear_adv_sets;
    HCI_ULP_PERIODIC_ADV_SET_PARAMS_T                   hci_ulp_set_pa_params;
    HCI_ULP_PERIODIC_ADV_SET_DATA_T                     hci_ulp_set_pa_data;
    HCI_ULP_PERIODIC_ADV_ENABLE_T                       hci_ulp_pa_enable;
    HCI_ULP_EXT_SCAN_SET_PARAMS_T                       hci_ulp_set_es_params;
    HCI_ULP_EXT_SCAN_ENABLE_T                           hci_ulp_es_enable;
    HCI_ULP_EXT_SCAN_CREATE_CONNECTION_T                hci_ulp_es_create_connection;
    HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_T               hci_ulp_ps_create_pa_sync;
    HCI_ULP_PERIODIC_SCAN_SYNC_TO_TRAIN_CANCEL_T        hci_ulp_ps_create_pa_sync_cancel;
    HCI_ULP_PERIODIC_SCAN_SYNC_TERMINATE_T              hci_ulp_ps_terminate_pa_sync;
    HCI_ULP_PERIODIC_SCAN_ADD_DEVICE_TO_PA_LIST_T       hci_ulp_ps_add_device_to_pa_list;
    HCI_ULP_PERIODIC_SCAN_REMOVE_DEVICE_FROM_PA_LIST_T  hci_ulp_ps_remove_device_from_pa_list;
    HCI_ULP_PERIODIC_SCAN_CLEAR_PA_LIST_T               hci_ulp_ps_clear_pa_list;
    HCI_ULP_PERIODIC_SCAN_READ_PA_LIST_SIZE_T           hci_ulp_ps_read_pa_list_size;
    HCI_ULP_PERIODIC_SCAN_SYNC_REPORT_PERIODIC_T        hci_ulp_ps_report_periodic;
    HCI_ULP_PERIODIC_ADV_SYNC_TRANSFER_T                hci_ulp_pa_sync_transfer;
    HCI_ULP_PERIODIC_ADV_SET_INFO_TRANSFER_T            hci_ulp_pa_set_info_transfer;
    HCI_ULP_PERIODIC_ADV_SET_SYNC_TRANSFER_PARAMS_T     hci_ulp_set_pa_sync_transfer_params;
    ...
    HCI_ULP_REQUEST_PEER_SCA_T                          hci_ulp_request_peer_sca;
    HCI_ULP_SET_CIG_PARAMETERS_T                        hci_ulp_set_cig_parameters;
    HCI_ULP_SET_CIG_PARAMETERS_TEST_T                   hci_ulp_set_cig_parameters_test;
    HCI_ULP_REMOVE_CIG_T                                hci_ulp_remove_cig;
    HCI_ULP_CREATE_CIS_T                                hci_ulp_create_cis;
    HCI_ULP_ACCEPT_CIS_REQUEST_T                        hci_ulp_accept_cis_request;
    HCI_ULP_REJECT_CIS_REQUEST_T                        hci_ulp_reject_cis_request;
    HCI_ULP_CREATE_BIG_T                                hci_ulp_create_big;
    HCI_ULP_CREATE_BIG_TEST_T                           hci_ulp_create_big_test;
    HCI_ULP_TERMINATE_BIG_T                             hci_ulp_terminate_big;
    HCI_ULP_BIG_CREATE_SYNC_T                           hci_ulp_big_create_sync;
    HCI_ULP_BIG_TERMINATE_SYNC_T                        hci_ulp_big_terminate_sync;
    HCI_ULP_ISO_TRANSMIT_TEST_T                         hci_ulp_iso_transmit_test;
    HCI_ULP_ISO_RECEIVE_TEST_T                          hci_ulp_iso_receive_test;
    HCI_ULP_ISO_READ_TEST_COUNTERS_T                    hci_ulp_iso_read_test_counters;
    HCI_ULP_SETUP_ISO_DATA_PATH_T                       hci_ulp_setup_iso_data_path;
    HCI_ULP_REMOVE_ISO_DATA_PATH_T                      hci_ulp_remove_iso_data_path;
    HCI_ULP_SET_HOST_FEATURE_T                          hci_ulp_set_host_feature;
    HCI_ULP_READ_ISO_LINK_QUALITY_T                     hci_ulp_read_iso_link_quality;
    HCI_ULP_SET_DEFAULT_SUBRATE_T                       hci_ulp_set_default_subrate;
    HCI_ULP_SUBRATE_REQUEST_T                           hci_ulp_subrate_request;
    HCI_ULP_ENHANCED_READ_TRANSMIT_POWER_LEVEL_T        hci_ulp_enhanced_read_transmit_power_level;
    HCI_ULP_READ_REMOTE_TRANSMIT_POWER_LEVEL_T          hci_ulp_read_remote_transmit_power_level;
    HCI_ULP_SET_PATH_LOSS_REPORTING_PARAMETERS_T        hci_ulp_set_path_loss_reporting_parameters;
    HCI_ULP_SET_PATH_LOSS_REPORTING_ENABLE_T            hci_ulp_set_path_loss_reporting_enable;
    HCI_ULP_SET_TRANSMIT_POWER_REPORTING_ENABLE_T       hci_ulp_set_transmit_power_reporting_enable;
    ...
    HCI_EV_ULP_CIS_ESTABLISHED_T                     hci_ulp_cis_established;
    HCI_EV_ULP_CIS_REQUEST_T                         hci_ulp_cis_request;
    HCI_EV_ULP_CREATE_BIG_COMPLETE_T                 hci_ulp_create_big_complete;
    HCI_EV_ULP_TERMINATE_BIG_COMPLETE_T              hci_ulp_terminate_big_complete;
    HCI_EV_ULP_BIG_SYNC_ESTABLISHED_T                hci_ulp_big_sync_established;
    HCI_EV_ULP_BIG_SYNC_LOST_T                       hci_ulp_big_sync_lost;
    HCI_EV_ULP_REQUEST_PEER_SCA_COMPLETE_T           hci_ulp_request_peer_sca_complete;
    HCI_EV_ULP_BIGINFO_ADV_REPORT_T                  hci_ulp_biginfo_adv_report;
    HCI_EV_ULP_SUBRATE_CHANGE_T                      hci_ulp_subrate_change;
    HCI_EV_ULP_PATH_LOSS_THRESHOLD_T                 hci_ev_ulp_path_loss_threshold;
    HCI_EV_ULP_TRANSMIT_POWER_REPORTING_T            hci_ev_ulp_transmit_power_reporting;
    ...
    HCI_EV_ENCRYPTION_CHANGE_V2_T                    hci_enc_change_event_v2;
} HCI_UPRIM_T;
