...
/* --------------------------------------------------------------------
   Name:
   CsrBtGattClientUtilFindIdentityAddrByConnIdEx

   Description:
   This API is used by an application/module for finding the Bluetooth
   Identity address corresponding to a particular btConnId.

  Parameters:
    CsrBtConnId             btConnId      - Connection identifier.
    CsrBtTypedAddr         *addr          - An allocated pointer to the
                                             address.
   -------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------
  Name: 
    CsrBtGattGetMtuFromConnInst

  Description: 
    This function is used to retrieve MTU for the specified connection id.

  Parameters: 
    CsrBtConnId     btConnId      - Connection identifier

  Return:
    MTU value will be returned to the application.
   ---------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------
   Name:
   CsrBtGattClientUtilGetCidByConnId

   Description:
   This API is used by an application/module for finding the cid 
   corresponding to a particular btConnId.

  Parameters:
    CsrBtConnId             btConnId      - Connection identifier.

  Return:
    cid will be returned to the application.
   -------------------------------------------------------------------- */
CsrUint16 CsrBtGattClientUtilGetCidByConnId(CsrBtConnId btConnId);

#ifdef INSTALL_CTM
/******************************************************************************
  GattIsClientHandleRegistered : Returns TRUE if handle is registered by app
