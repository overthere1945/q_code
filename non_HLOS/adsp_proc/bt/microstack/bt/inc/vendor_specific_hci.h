...
#define HCI_VS_PROD_TEST_COMMANDS                ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x004)
...
#define QCT_TWS_SHADOW_CMD_OPCODE                ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x00E)
#define HCI_VS_LINK_STATUS_CMD_OPCODE            ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x00F)
#define HCI_VS_WR_BT_ADDR                        ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x014)
...
#define QCT_QBC_CMD_OPCODE                       ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x051)
#define HCI_VS_LINK_POWER_CTRL_REQ               ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x0DA)
#define HCI_VS_BCAUD_CDA                         ((hci_op_code_t)HCI_MANUFACTURER_EXTENSION| 0x025)
#endif
/******************************************************************************
 ...
 ******************************************************************************/
/* The following SubOpcodes relate to NVM access. Opcode = 0xFC0B. */
...
/* The following SubOpcodes relate to the Embedded Downloader (EDL). Opcode = 0xFC00. */
...
/* The following SubOpcodes support the Lower Tester feature. Opcode = 0xFC18. */
#define SUB_OPCODE_LT_DATA_LENGTH                                                       ((uint8_t) 0x0B)
#define SUB_OPCODE_LT_PHY_TEST_MODE                                                     ((uint8_t) 0x0C)
/* The following SubOpcodes relate to vendor-specific service control. Opcode = 0xFC50. */
...
/* The following SubOpcodes relate to TrueWireless Mirroring. Opcode = 0xFC0E. */
...
#define SUB_OPCODE_QCT_TWSS_SET_PRIMARY_SECONDARY_BD_ADDRS                              ((uint8_t) 0x0F)
/* The following SubOpcodes relate to output power control. Opcode = 0xFCDA. */
...
/* The following SubOpcodes relate to vendor-specific LLM commands. Opcode = 0xFFFF. */
...
/* The following SubOpcodes relate to vendor debug commands. Opcode = 0xFC0C. */
...
/* The following SubOpcodes relate to AFH in combination with CPB on CDA devices. Opcode = 0xFC25. */
...
/* The following SubOpcodes relate to the product test command interface. Opcode = 0xFC04. */
...
#define BUDDY_ROLE_PRIMARY      ((uint8_t)0x00)
#define BUDDY_ROLE_SECONDARY    ((uint8_t)0x01)
#endif
