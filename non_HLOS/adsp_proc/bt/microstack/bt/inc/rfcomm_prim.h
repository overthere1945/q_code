...
Copyright (c) 2001 - 2021 Qualcomm Technologies International, Ltd.
All Rights Reserved.
...
#else
} RFC_FC_enum_T; /* autogen_makefile_ignore_this */
typedef uint16_t RFC_FC_T;
#endif
