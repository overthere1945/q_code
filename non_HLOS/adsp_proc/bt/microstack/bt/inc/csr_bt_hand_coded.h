...
CsrUint8 *CsrBtCmSmAddDeviceReqSer(CsrUint8 *ptr, CsrSize *length, void *voidPrimitivePointer);
void *CsrBtCmSmAddDeviceReqDes(CsrUint8 *buffer, CsrSize length);
void CsrBtCmSmAddDeviceReqSerFree(void *voidPrimitivePointer);
CsrSize CsrBtCmSmAddDeviceReqSizeof(void *voidPrimitivePointer);
