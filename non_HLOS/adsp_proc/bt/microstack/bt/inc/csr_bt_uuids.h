...
#define CSR_BT_GATT_UUID_TIRE_PRESSURE_MONITORING_SERVICE       ((CsrBtUuid16) 0x1815) /* TPMS - For testing purpose using uuid of
                                                                                           CSR_BT_GATT_UUID_AUTOMATION_IO_SERVICE as TPMS service */
...
#define GATT_UUID_SECURITY_LEVEL_CHARAC                            ((CsrBtUuid16) 0x2BF5) /* LE GATT Security Levels */
#define CSR_BT_GATT_UUID_SERVICE_CHANGED_CHARAC                    ((CsrBtUuid16) 0x2A05) /* Service Changed */
#define CSR_BT_GATT_UUID_DATABASE_HASH_CHARAC                      ((CsrBtUuid16) 0x2B2A) /* Database Hash */
#define CSR_BT_GATT_UUID_CLIENT_SUPPORTED_FEATURES_CHARAC          ((CsrBtUuid16) 0x2B29) /* Client Supported Features */
#define CSR_BT_GATT_UUID_SERVER_SUPPORTED_FEATURES_CHARAC          ((CsrBtUuid16) 0x2B3A) /* Server Supported Features */
...
#define CSR_BT_GATT_UUID_TIRE_PRESSURE_CHARAC                      ((CsrBtUuid16) 0x2ACA) /* Tire Pressure  */
#define CSR_BT_GATT_UUID_TIRE_TEMPERATURE_CHARAC                   ((CsrBtUuid16) 0x2ACB) /* Tire Temperature */
#define CSR_BT_GATT_UUID_SENSOR_THRESHOLD_CHARAC                   ((CsrBtUuid16) 0x2ACC) /* Sensor Threshold */
#define CSR_BT_GATT_UUID_DISC_AND_CONN_MGMT_CHARAC                 ((CsrBtUuid16) 0x2ACD) /* Discovery and Connection management */
#define CSR_BT_GATT_UUID_ADVERTISING_PERIOD_CHARAC                 ((CsrBtUuid16) 0x2ACE) /* Advertising Period */
#define CSR_BT_GATT_SENSOR_POSITION_CHARAC                         ((CsrBtUuid16) 0x2ACF) /* Sensor Position */
#define GATT_UUID_ENCRYPTED_DATA_KEY_MATERIAL_CHARAC               ((CsrBtUuid16) 0x2B88) /* Encrypted Data Key Material */

#define CSR_BT_GATT_UUID_CHARACTERISTICS_END                       ((CsrBtUuid16) 0x2ACF)
...
#define GATT_UUID_ENCRYPTED_DATA_KEY_MATERIAL_CHARAC_STR               "Encrypted Data Key Material"
