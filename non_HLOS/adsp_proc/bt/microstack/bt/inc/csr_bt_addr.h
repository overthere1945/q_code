...
typedef BD_ADDR_T CsrBdAddr;
typedef CsrUint8 CsrBtAddressType;
typedef PHYSICAL_TRANSPORT_T CsrBtTransportType;
typedef CsrUint8 CsrBtOwnAddressType;
typedef CsrUint8 CsrBtTransportMask;

#define CSR_BT_ADDR_PUBLIC  TBDADDR_PUBLIC
#define CSR_BT_ADDR_RANDOM TBDADDR_RANDOM
#define CSR_BT_ADDR_INVALID TBDADDR_INVALID

#define CSR_BT_ADDR_PRIVATE CSR_BT_ADDR_RANDOM

/* Valid CsrBtTransportType values */
#define CSR_BT_TRANSPORT_BREDR    (BREDR_ACL)
#define CSR_BT_TRANSPORT_LE       (LE_ACL)

#define CSR_BT_TRANSPORT_TYPE_FLAG_BREDR    ((CsrBtTransportMask) (1 << CSR_BT_TRANSPORT_BREDR))
#define CSR_BT_TRANSPORT_TYPE_FLAG_LE       ((CsrBtTransportMask) (1 << CSR_BT_TRANSPORT_LE))
...
/* Copy */
#define CsrBtAddrCopy(dst,src)  *(dst) = *(src)
