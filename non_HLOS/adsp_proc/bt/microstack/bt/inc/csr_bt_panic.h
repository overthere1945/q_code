...
#define BT_PANIC_SM_INVALID_STATE                                  (CSR_BT_PANIC_BASE_BLUESTACK + 0x2E) /* PANIC_SM_INVALID_STATE */
#define BT_PANIC_WRONG_SENDER_HCI_CMD_ARB                          (CSR_BT_PANIC_BASE_BLUESTACK + 0x2F) /* PANIC_WRONG_SENDER_HCI_CMD_ARB */
#define BT_PANIC_INVALID_APP_HANDLE                                (CSR_BT_PANIC_BASE_BLUESTACK + 0x30) /* PANIC_INVALID_APP_HANDLE */
#define BT_PANIC_INVALID_SCAN_ARB_STATE                            (CSR_BT_PANIC_BASE_BLUESTACK + 0x31) /* BT_PANIC_INVALID_SCAN_ARB_STATE */
#define BT_PANIC_INVALID_SCAN_PARM_NOT_CACHED_STATE                (CSR_BT_PANIC_BASE_BLUESTACK + 0x32) /* BT_PANIC_INVALID_SCAN_PARM_NOT_CACHED_STATE */
#define BT_PANIC_NO_APP_CALLBACK                                   (CSR_BT_PANIC_BASE_BLUESTACK + 0x33) /* BT_PANIC_NO_APP_CALLBACK */
...
/* Offload defined panic IDs */
#define CSR_BT_PANIC_BASE_OFFLOAD                                   0x80
#define BT_OFFLOAD_PANIC_PROTO_MISMATCH                            (CSR_BT_PANIC_BASE_OFFLOAD + 0x00) /* BT_OFFLOAD_PANIC_PROTO_MISMATCH */
#define BT_OFFLOAD_PANIC_RFCOMM_NULL                               (CSR_BT_PANIC_BASE_OFFLOAD + 0x01) /* BT_OFFLOAD_PANIC_RFCOMM_NULL */
#define BT_OFFLOAD_PANIC_LECOC_NULL                                (CSR_BT_PANIC_BASE_OFFLOAD + 0x02) /* BT_OFFLOAD_PANIC_LECOC_NULL */
#define BT_OFFLOAD_PANIC_HCI_ARB_INV_PARAM                         (CSR_BT_PANIC_BASE_OFFLOAD + 0x03) /* BT_OFFLOAD_PANIC_HCI_ARB_INV_PARAM */
#define BT_OFFLOAD_PANIC_HCI_ARB_INV_HCI_MSG                       (CSR_BT_PANIC_BASE_OFFLOAD + 0x04) /* BT_OFFLOAD_PANIC_HCI_ARB_INV_HCI_MSG */
#define BT_OFFLOAD_PANIC_INVALID_PARAMS                            (CSR_BT_PANIC_BASE_OFFLOAD + 0x05) /* BT_OFFLOAD_PANIC_INVALID_PARAMS */
#define BT_OFFLOAD_INVALID_CONTINUE_FRAG                           (CSR_BT_PANIC_BASE_OFFLOAD + 0x06) /* BT_OFFLOAD_INVALID_CONTINUE_FRAG */
#define BT_OFFLOAD_RFCOMM_DLCI_EXISTS                              (CSR_BT_PANIC_BASE_OFFLOAD + 0x07) /* BT_OFFLOAD_RFCOMM_DLCI_EXISTS */
