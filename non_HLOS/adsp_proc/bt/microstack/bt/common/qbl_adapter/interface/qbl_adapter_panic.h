...
#define PANIC_WRONG_SENDER_HCI_CMD_ARB                      BT_PANIC_WRONG_SENDER_HCI_CMD_ARB
#define PANIC_OFFLOAD_INVALID_PARAMS                        BT_OFFLOAD_PANIC_INVALID_PARAMS
#define PANIC_OFFLOAD_INVALID_CONTINUE_FRAG                 BT_OFFLOAD_INVALID_CONTINUE_FRAG
#define PANIC_OFFLOAD_RFCOMM_DLCI_EXISTS                    BT_OFFLOAD_RFCOMM_DLCI_EXISTS
