...
LOCAL_C_INCLUDES += $(BOARD_OPENSOURCE_DIR)/fm/helium \
...
ifeq ($(TARGET_USES_QTI_BTFTM_SS),true)
LOCAL_CFLAGS += -DSS_BT_FTM_MODE
else
LOCAL_CFLAGS += -DBT_FTM_MODE
endif
...
ifneq ($(TARGET_USES_QTI_BTFTM_SS),true)
