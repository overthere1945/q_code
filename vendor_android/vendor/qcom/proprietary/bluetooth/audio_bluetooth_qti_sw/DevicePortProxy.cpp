...
bool BluetoothAudioPortAidl::updateSourceMetadata(const SourceMetadata& source_metadata) const {
    ...
    BluetoothAudioSessionControl::UpdateSourceMetadata(mSessionType, (const struct source_metadata&)source_metadata);
    return true;
}
...
bool BluetoothAudioPortAidl::updateSinkMetadata(const SinkMetadata& sink_metadata) const {
    ...
    BluetoothAudioSessionControl::UpdateSinkMetadata(mSessionType, (const struct sink_metadata&)sink_metadata);
    return true;
}
