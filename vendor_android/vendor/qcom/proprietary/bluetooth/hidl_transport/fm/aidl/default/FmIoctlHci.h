...
//using ::aidl::vendor::qti::hardware::fm::V1_0::HciPacket;
...
struct FmIoctlHal : public BnFmHci {

private:
    std::shared_ptr<IFmHciCallbacks> mCb = nullptr;
    static std::shared_ptr<IFmHciCallbacks> event_cb;
    static struct fm_hal_t *fmhal;
    std::shared_ptr<FmIoctlDeathRecipient> mDeathRecipient;
