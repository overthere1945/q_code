...
#undef LOG_TAG
#endif
#define LOG_TAG "vendor.qti.bluetooth@1.1-bluetooth_hci"
...
using android::hardware::bluetooth::V1_0::implementation::RX_PRE_STACK_EVT_CALL_BACK;
using android::hardware::bluetooth::V1_0::implementation::RX_PRE_STACK_ACL_CALL_BACK;
using android::hardware::bluetooth::V1_0::implementation::RX_PRE_STACK_ISO_CALL_BACK;
using android::hardware::bluetooth::V1_0::implementation::RX_POST_STACK_ACL_CALL_BACK;
using android::hardware::bluetooth::V1_0::implementation::RX_POST_STACK_EVT_CALL_BACK;
using android::hardware::bluetooth::V1_0::implementation::RX_POST_STACK_ISO_CALL_BACK;
...
Return<void> BluetoothHci::initialize_1_1(
  ...
  auto rc = DataHandler::Init( TYPE_BT,
    [this, event_cb_tmp](bool status) {
      ...
      if (event_cb_ != nullptr) {
        auto hidl_client_status = event_cb_tmp ->initializationComplete(
          status ? V1_0::Status::SUCCESS : V1_0::Status::INITIALIZATION_ERROR);
...
class OldCbWrapper : public V1_1::IBluetoothHciCallbacks {
 public:
  ...
  Return<bool> linkToDeath(
    const ::android::sp<::android::hardware::hidl_death_recipient>& recipient,
    uint64_t cookie) override {
    return old_cb_->linkToDeath(recipient, cookie);
  };

  Return<bool> unlinkToDeath(
    const ::android::sp<::android::hardware::hidl_death_recipient>& recipient) override {
    return old_cb_->unlinkToDeath(recipient);
  };
};
...
Return<void> BluetoothHci::close()
{
  ...
  if (event_cb_ != nullptr) event_cb_->unlinkToDeath(death_recipient_);
