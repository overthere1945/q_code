...
#define SPI_IPC_TX_LOG_PREFIX  "ramdump_bt_spi_ipc_tx_"
#define SPI_IPC_RX_LOG_PREFIX  "ramdump_bt_spi_ipc_rx_"
#define SPI_IPC_STATE_LOG_PREFIX "ramdump_bt_spi_ipc_state_"
#define SPI_IPC_PWR_LOG_PREFIX "ramdump_bt_spi_ipc_pwr_"

#define TRANSPORT_IPC_PATH_BUF_SIZE 255
...
class IpcLogs
{
 ...
 public:
  ...
  const unsigned long SPI_IPC_LOG_TX_RX_MAX_SIZE = 2 * 30 * 4 * 1024;  // 2 times 30 pages of 4K size
  const unsigned long SPI_IPC_LOG_MAX_READ_PER_ITERATION = 16 * 1024;

  enum transport_crash_type{
    TX_LOG,
    RX_LOG,
    STATE_LOG,
    POWER_LOG,
  };
  void DumpTransportLogs();
  IpcLogs() {};
};
