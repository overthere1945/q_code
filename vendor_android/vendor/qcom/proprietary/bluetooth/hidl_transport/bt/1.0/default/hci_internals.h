...
#define ANT_PACKET_HDR        0x02
#define HCI_PACKET_ISO_PAYLOAD 0x3F

#define SPI_DEFAULT_SLEEP_BIT          0x00   // SPI Sleep Undefined
#define SPI_DISABLE_SOFT_RESET_BIT     0x01   // SPI Sleep Disabled
#define SPI_ENABLE_SLEEP_BIT           0x02   // SPI Sleep Enabled
...
enum HciPacketType {
  ...
  HCI_PACKET_TYPE_PERI_CMD   = 0x31,
  HCI_PACKET_TYPE_PERI_EVT   = 0x34,
  HCI_PACKET_TYPE_PERI_DATA  = 0x32,
  HCI_PACKET_TYPE_CMD_FROM_HAL = 0x0A,
};
...
const size_t PERI_EVT_LENGTH_OFFSET = 2;
