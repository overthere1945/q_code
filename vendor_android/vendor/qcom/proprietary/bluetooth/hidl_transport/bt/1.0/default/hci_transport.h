...
typedef enum {
  BT_TRANSPORT_TYPE_DEFAULT = 0,
  BT_TRANSPORT_TYPE_SMD = BT_TRANSPORT_TYPE_DEFAULT,
  BT_TRANSPORT_TYPE_UART,
  BT_TRANSPORT_TYPE_SPI,
  BT_TRANSPORT_TYPE_RESERVED
