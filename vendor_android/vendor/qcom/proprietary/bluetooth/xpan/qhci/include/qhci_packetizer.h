...
typedef enum {
  ...
  QHCI_TRANSPORT_STATE_CHANGE,
  QHCI_AC_REMOTE_AVAILABLE_FOR_CONN,
  QHCI_SAP_ENABLE_STATUS,
  QHCI_AC_DISCONNECT_LE_LINK,
  QHCI_AC_IDLE_TRANSTITION_STATUS,
  QHCI_INITIATED_SEAMLESS_FAILED,
} QHciEventId;
...
typedef union {
  ...
  QHciTransportStateChange TransportStateChg;
  QHciRemoteAvailable RemoteAvailable;
  QHciSapEnableStatus SapEnableStatus;
  QHciDisconnectLeLink DisconnectLeLink;
  QHciIdleTransitionStatus IdleTransitionStatus;
  QHciInitiatedSeamlessFailed InitiatedSeamlessFailed;
} qhci_msg_t;
