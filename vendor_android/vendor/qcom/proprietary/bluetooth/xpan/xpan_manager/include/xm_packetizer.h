...
#define BTM_CP_CTRL_ROLE_SWITCH_IND                           0x20000009
#define BTM_CP_CTRL_BSSID_UPDATE_IND                          0x2000000B
...
#define BTM_CP_CTRL_TWT_EST_REQ                               0x20001005
#define BTM_CP_CTRL_REMOTE_PARAMS_REQ                         0x20001006
...
/* Event/Error sent from CP to XM */
#define BTM_CP_TIME_SYNC_IND                                  0x21000004
#define BTM_CP_LOG_EVENT_IND                                  0x21000005
...
#define BTM_CP_CTRL_TWT_EST_RSP                               0x21002005
#define BTM_CP_CTRL_REMOTE_PARAMS_RSP                         0x21002006
...
#define BTM_KP_PORT_STATE_IND_LEN                             (9)
#define BTM_BTFMCODEC_CONFIG_DMA_REQ_LEN                      (20)
#define BTM_CP_CONFIG_DMA_RSP_LEN                             (10)
#define BTM_USECASE_START_LEN                                 (10)
#define BTM_TWT_EST_RSP_LEN                                   (9)
#define BTM_CP_CTRL_REMOTE_PARAMS_RSP_LEN                     (9)
...
#define PARSE_TO_FIRST32(timestamp)    (uint32_t)((timestamp) >> 32)
#define PARSE_TO_SECOND32(timestamp)   (uint32_t)timestamp
...
static inline char *OpcodeToString(uint32_t opcode)
{
  ...
  else if (opcode == BTM_CP_TIME_SYNC_IND)
    return "BTM_CP_TIME_SYNC_IND";
  else if (opcode == BTM_CP_LOG_EVENT_IND)
    return "BTM_CP_LOG_EVENT_IND";
  ...
  else if (opcode  == BTM_CP_CTRL_ROLE_SWITCH_IND)
    return "BTM_CP_CTRL_ROLE_SWITCH_IND";
  else if (opcode  == BTM_CP_CTRL_BSSID_UPDATE_IND)
    return "BTM_CP_CTRL_BSSID_UPDATE_IND";
  else if (opcode  == BTM_CP_CTRL_ADSP_STATE_IND)
    return "BTM_CP_CTRL_ADSP_STATE_IND";
  else if (opcode  == BTM_BTFMCODEC_USECASE_START_REQ)
    return "BTM_BTFMCODEC_USECASE_START_REQ";
  else if (opcode  == BTM_BTFMCODEC_USECASE_START_RSP)
    return "BTM_BTFMCODEC_USECASE_START_RSP";
  else if (opcode  == BTM_CP_CTRL_TWT_EST_REQ)
    return "BTM_CP_CTRL_TWT_EST_REQ";
  else if (opcode == BTM_CP_CTRL_REMOTE_PARAMS_REQ)
    return "BTM_CP_CTRL_REMOTE_PARAMS_REQ";
  else if (opcode == BTM_CP_CTRL_REMOTE_PARAMS_RSP)
    return "BTM_CP_CTRL_REMOTE_PARAMS_RSP";
  else
...
class XMPacketizer
{
 public:
  ...
  void WARUseCaseRsp(RspStatus);
  void CpLogEventAndTimestamp(uint32_t, xm_ipc_msg_t *);
 private:
