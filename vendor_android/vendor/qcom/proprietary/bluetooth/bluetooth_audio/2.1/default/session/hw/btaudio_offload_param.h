...
using ::vendor::qti::hardware::bluetooth_audio::V2_1::IBluetoothAudioProvider;
...
struct a2dp_stream_common {
    ...
    AudioConfiguration_2_0  codec_cfg_2_0; 
...
#define LC3_CHANNELS_MONO          (0x01)
#define LC3_CHANNELS_STEREO        (0x02)
#define LC3_CHANNELS_JOINT_STEREO  (0x04)
#define LC3_CHANNELS_5_1           (0x08)
