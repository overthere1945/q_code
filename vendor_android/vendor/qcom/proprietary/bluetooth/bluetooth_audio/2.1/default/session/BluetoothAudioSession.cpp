...
BluetoothAudioSession::BluetoothAudioSession(const SessionType& session_type)
  : session_type_(session_type), stack_iface_(nullptr), stack_iface_2_0_(nullptr), mDataMQ(nullptr), client_2_0_(false) {
 ...
 */
bool BluetoothAudioSession::a2dpGetSinkLatency(const SessionType& session_type,
  ...
  BluetoothA2dpControl *a2dpControl = BluetoothA2dpControl::getA2DPControl();
  if(a2dpControl) {
    ret = a2dpControl->getSinkLatency(session_type, remote_delay_report_ns,
