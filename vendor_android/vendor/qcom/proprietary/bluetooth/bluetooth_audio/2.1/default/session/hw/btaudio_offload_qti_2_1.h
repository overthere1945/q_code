...
extern bool bt_audio_pre_init_qti(void);
extern bool audio_is_scrambling_enabled_qti(void);
extern int audio_sink_stream_start_qti(void);
extern int audio_sink_stream_stop_qti(void);
extern int audio_sink_stream_suspend_qti(void);
