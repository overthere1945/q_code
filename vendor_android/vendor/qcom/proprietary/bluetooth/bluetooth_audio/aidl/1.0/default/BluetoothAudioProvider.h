...
class BluetoothCodecExtensiblityFlags {
 public:
  static inline bool kEnableA2dpCodecExtensibility;
  static inline bool kEnableHfpCodecExtensibility;
  static inline bool kEnableLeAudioCodecExtensibility;
};
...
class BluetoothAudioProvider : public BnBluetoothAudioProvider {
 public:
  ...
  virtual MetadataLtv::VendorSpecific
