...
static const char *QSH_DATATYPE_SIGNIFICANT_MOTION = "sig_motion";

class sig_motion : public qsh_sensor
{
public:
    sig_motion(suid sensor_uid, sensor_wakeup_type wakeup);
    static const char* qsh_datatype() { return QSH_DATATYPE_SIGNIFICANT_MOTION; }
...
sig_motion::sig_motion(suid sensor_uid, sensor_wakeup_type wakeup):
...
static bool sig_motion_module_init()
{
    ...
    sensor_factory::register_sensor(SENSOR_TYPE_SIGNIFICANT_MOTION,
        qsh_sensor::get_available_wakeup_sensors<sig_motion>);
    sensor_factory::request_datatype(QSH_DATATYPE_SIGNIFICANT_MOTION);
    return true;
}
