...
public class USTACmdLineService extends Service {
  ...
  public void onCreate() {
    ...
    if (null == USTACmdLineReceiverReceiver) {
      ...
      try {
        this.registerReceiver(USTACmdLineReceiverReceiver, USTACmdLineReceiverReceiver.getIntentFilter(), Context.RECEIVER_EXPORTED);
      } catch (Exception e) {
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    String notificationChannelID = "com.qualcomm.qti.usta";
    NotificationChannel nc = new NotificationChannel(notificationChannelID, "USTACmdLineService",
                                                      NotificationManager.IMPORTANCE_DEFAULT);
    NotificationManager nm = (NotificationManager)getSystemService(Context.NOTIFICATION_SERVICE);
    nm.createNotificationChannel(nc);
    Notification notification = new Notification.Builder(this, notificationChannelID)
            .setContentTitle("USTACmdLineService")
            .setContentText("is running in the foreground")
            .setSmallIcon(R.drawable.usta_icon)
            .build();
    USTALog.i("starting in the Foreground");
