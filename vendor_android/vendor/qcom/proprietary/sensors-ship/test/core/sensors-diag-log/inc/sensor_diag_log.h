...
typedef struct pending_req_mesg
{
  std::string request_msg = "";
  std::string src_sensor_data_type = "";
  std::string logging_module_type =  "";
  uint64_t log_time_stamp;
}sns_diag_req_mesg_data;
/**
...
public:
  ...
  */
  ...
  sensors_diag_log_return_code log_event_msg(
      ...
      const std::string &src_sensor_data_type,
  ...
  void update_client_connect_id(uint64_t client_connect_id);
...
private:
  ...
  sensors_diag_log_return_code submit_log_packet(
      ...
      std::string &pb_encoded_sns_diag_sensor_log);
  ...
  */
  ...
  bool is_client_connect_id_updated;
  std::vector<sns_diag_req_mesg_data> pending_req_msg;
  std::mutex     _mutex;
  std::mutex     _mutex_pending_req_msg;
