...
static const Method methods[3] = {{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x1),0x4,0x0,2,2,(&(parameterArrays[2])),0x4,0x1},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x1,0x0),0x0,0x0,1,1,(&(parameterArrays[4])),0x1,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x2,0x1,0x0,0x0),0x4,0x4,3,2,(&(parameterArrays[0])),0x4,0x4}};
static const Method* const methodArrays[3] = {&(methods[0]),&(methods[1]),&(methods[2])};
static const char strings[33] = "result\0close\0open\0vec\0set\0uri\0h\0";
static const uint16_t methodStrings[8] = {22,18,0,13,26,30,7,30};
static const uint16_t methodStringsArrays[3] = {3,6,0};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(sns_device_mode_slim) = {3,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(sns_device_mode_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(sns_device_mode_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(sns_device_mode_set)(remote_handle64 _handle, const char* vec, int vecLen, uint32* result) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method(_handle, _mid, (char**)&vec, (uint32_t*)&vecLen, (uint32_t*)result);
}
#ifdef __cplusplus
}
#endif
